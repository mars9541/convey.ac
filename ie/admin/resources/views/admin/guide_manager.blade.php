        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane p-3" id="sample_email" role="tabpanel">
                    <form>
                        <input type="hidden" name="flag" value="business_email">
                        <div class="form-group">
                            <label class="col-form-label">Sample Business Email</label>
                            <div class="col-lg-12">
                                <textarea name="content" class="summernote">{{App\Guide::where('flag', 'business_email')->first()->content}}</textarea>
                            </div>
                        </div>
                    ...
                    <form>
                        <input type="hidden" name="flag" value="advisors_email">
                        <div class="form-group">
                            <label class="col-form-label">Sample Advisor Email</label>
                            <div class="col-lg-12">
                                <textarea name="content" class="summernote">{{App\Guide::where('flag', 'advisors_email')->first()->content}}</textarea>
                            </div>
                        </div>
                    ...
                    <form>
                        <input type="hidden" name="flag" value="hris_email">
                        <div class="form-group">
                            <label class="col-form-label">Sample Hris Email</label>
                            <div class="col-lg-12">
                                <textarea name="content" class="summernote">{{App\Guide::where('flag', 'hris_email')->first()->content}}</textarea>
                            </div>
                        </div>
