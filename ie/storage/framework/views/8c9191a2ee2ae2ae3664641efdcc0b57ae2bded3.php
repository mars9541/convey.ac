                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">€11<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">€5<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                                            <div class="plan-div-border"></div>
                                        </div>
                                        <div class="plan-features pb-3 mt-3 text-muted padding-t-b-30 line-height-50">
                    ...
                    <div class="custom-padding-top">
                        <table id="invoice_table" class="table table-bordered table-striped m-t-40">
                            ...
                            <tr>
                                ...
                                <td class="text-center p-2 download"><a href="<?php echo e(route('advisors.invoice_download',['id'=>$item->id])); ?>" class="text-convey-green">Download</a></td>
                            </tr>
                            <tr>
                                <td class="text-center p-2">Payment Receipt</td>
                                <td class="text-center p-2"><?php echo e(date_format(date_create($item->date_of_payment),'d/m/Y')); ?></td>
                                <td class="text-center p-2 download"><a href="<?php echo e(route('advisors.receipt_download',['id'=>$item->id])); ?>" class="text-convey-green">Download</a></td>
                            </tr>
...
<form action="<?php echo e(route('advisors.buy_credits')); ?>" method="post" style="display: none" id="buy_credits_form">
    <?php echo csrf_field(); ?>
...
<script
    src="https://www.paypal.com/sdk/js?client-id=Af_Ms0n04D2x5xKfjM5sAqVwOKbRPSCFjq-ag1bKUh1-NqQAWFYsxPwV_FMcUsSrFzGlG3JoTuqjW2oh&currency=EUR"> // Required. Replace YOUR_CLIENT_ID with your sandbox client ID.
</script>
<script>
    ...
    function buy_credits(package_type, details)
    {
        ...
        $.ajax({
            url:"<?php echo e(route('advisors.paypal_buy_credits')); ?>",
            method:"POST",
            data:formData,
            cache: false,
            contentType: false,
...
console.log(balance);*/
                window.location = "<?php echo e(route('advisors.search-credits')); ?>";
            }
        })
    }
    ...
    function get_purchase_amount(package_number) {
        ...
        $.ajax({
            url:"<?php echo e(route('advisors.get_purchase_amount')); ?>",
            method:"POST",
            data:formData,
            cache: false,
            contentType: false,
    ...
    $('#credits_history').DataTable({
        ...
        ajax:{
            url: "<?php echo e(route('advisors.search_credits')); ?>",
            method:'post',
            data:{
...
<?php echo $__env->make('layouts.master-advisors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/ie/resources/views/front/advisors/search-credits.blade.php ENDPATH**/ ?>