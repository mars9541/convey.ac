                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <?php if($user_info->business_type=='organisation'): ?>
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="IE" name="company_lrd_country">
                                            ...
                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                ...
                                                <option value="<?php echo e($key); ?>" <?php if( $key == "IE" ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Organisation Headquarter - Eircode:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Mailing Address - Eircode:</label>
                                        <div class="col-md-7 display-inline">
                                ...
                                <?php elseif($user_info->business_type=='company'): ?>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Company Headquarter - Eircode:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="company_ma_postcode" value="<?php echo e($user_info->company_ma_postcode); ?>" />
                                        </div>
                                    </div>
                                ...
                                <?php elseif($user_info->business_type=='selfemployed'): ?>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="IE" name="lrd_country_show">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Eircode:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_postcode" value="<?php echo e($user_info->ma_postcode); ?>" />
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form id="form_list_service">
                                <div class="col-md-10 m-t-10 display-inline text-center">
                                    <label class="col-form-label text-center color-black-light" style="font-size: 1.25rem;">So We can list you’re your services on our ‘Find Help’ pages, please provide the following information.</label>
                                </div>
...
<?php echo $__env->make('layouts.master-hris', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/ie/resources/views/front/hris/settings.blade.php ENDPATH**/ ?>