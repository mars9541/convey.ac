        ...
        <div class="container login-container">
            <div class="loginPage loginForm">
                ...
                <div class="loginDetail">
                    <div class="loginDetail-inner" style="max-width: 440px;">
                        ...
                        <div class="col-sm-12 alert alert-convey-success alert-dismissible fade show text-white" style="background-color: #3BC850;" role="alert">
                            ...
                            <strong>Warning!</strong> <?php echo e($errors->first('email')); ?>
                        ...
                        <input type="email" class="form-control" name="email" placeholder="Enter Your Email Address" required value="<?php echo e(old('email')); ?>">
                ...
                <div class="loginBottom" style="width: 440px;">
					...
					<a href="<?php echo e(route('login_retrieval')); ?>" class="clickhere text-convey-green" >Click here to retrieve your details</a>
                </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/ie/resources/views/auth/login.blade.php ENDPATH**/ ?>