                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            ...
                            <li class="float-none">
                                <a onclick="onCountrySite('ru')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/russia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="England">
                                    <span>Russia</span>
                                </a>
                            </li>
                        </ul>
...
<?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/ie/resources/views/layouts/frontend-footer.blade.php ENDPATH**/ ?>