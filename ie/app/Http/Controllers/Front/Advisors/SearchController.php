...
class SearchController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('front.advisors.search', compact('NI_min_number', 'connect_flag'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $messages = array(
            'NI_number.min' => 'The Personal Public Service Number for the Ireland is set so it must be at least '.$min_num.' characters long.',
        );
