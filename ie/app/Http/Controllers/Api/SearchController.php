...
class SearchController extends Controller
{
    ...
    {
        if($request->National_Number != 'ABC123456') {
        ...
        $messages = array(
            'National_Number.min' => 'The Personal Public Service Number for the Ireland is set so it must be at least '.$min_num.' characters long.',
        );
                ...
                if(count($max_version) > 0) {
                    foreach ($max_version as $key => $child) {
                        ...
                        if($request->National_Number != 'ABC123456') {
                            ...
                            $child_record_pattern_array->Record_creators_CBR_id = "IE000000";
...
//                    array_push($item_child, $child_record_pattern_array);
                ...
                if($request->National_Number != 'ABC123456') {
                    ...
                    $record_pattern_array->Record_creators_CBR_id = "IE000000";
