        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            <li><a href="{{url('/press')}}">プレス</a></li>
                            <li><a href="{{url('/brand')}}">ブランドについてのガイドライン</a></li>
                            <li><a href="{{url('/getintouch')}}"> お問い合わせ</a></li>
                            <li><a href="javascript:onOpenModal('cookies')"> Cookies</a></li>
                            <li><a href="javascript:onOpenModal('privacy')"> プライバシー</a></li>
                            <li><a href="javascript:onOpenModal('legal')"> 法律</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="{{asset('landing_front')}}/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="イギリス">
                                    <span>イギリス</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="{{asset('landing_front')}}/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="アメリカ">
                                    <span>アメリカ</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ca')">
                                    <img src="{{asset('landing_front')}}/images/country/canada.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="カナダ">
                                    <span>カナダ</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ie')">
                                    <img src="{{asset('landing_front')}}/images/country/ireland.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="アイルランド">
                                    <span>アイルランド</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('au')">
                                    <img src="{{asset('landing_front')}}/images/country/australia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="オーストラリア">
                                    <span>オーストラリア</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="{{asset('landing_front')}}/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="スペイン">
                                    <span>スペイン</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="{{asset('landing_front')}}/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="ドイツ">
                                    <span>ドイツ</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('fr')">
                                    <img src="{{asset('landing_front')}}/images/country/france.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="フランス">
                                    <span>フランス</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="{{asset('landing_front')}}/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="イタリア">
                                    <span>イタリア</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="{{asset('landing_front')}}/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="日本">
                                    <span>日本</span>
                                </a>
                            </li>
                            {{--<li class="float-none">
                                <a onclick="onCountrySite('ru')">
                                    <img src="{{asset('landing_front')}}/images/country/russia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="ロシア">
                                    <span>ロシア</span>
                                </a>
                            </li>--}}
                        </ul>
...
<div class="modal fade bs-example-modal-lg" id="privacy_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">個人情報保護方針</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 1.75rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 1rem!important;">会社名：CONVEY Databank Ltd <br>
                        会社の住所:  85 Great Portland Street, First Floor, London, W1W7LT
                    </p>
                    <p style="margin-bottom: 1rem!important;">
                        CONVEYでは、お客様のプライバシーを大切にしています。
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        このプライバシーポリシーは、お客様がどのようにCONVEYを使用するかによって若干異なります。例えば、個人が自分に関する記録を見つけるためにCONVEYを使用する場合と、企業が記録を作成するためにCONVEYを使用する場合とでは、若干異なるポリシーになります。
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        完全な関連する利用規約は、アカウント作成の過程で見ることができます。
                    </p>
...
<div class="modal fade bs-example-modal-lg" id="legal_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">法律</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 2rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 0.7rem!important;">会社名：CONVEY Databank Ltd </p>
                    <p style="margin-bottom: 0.7rem!important;">会社の住所  85 Great Portland Street, First Floor, London, W1W7LT </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        https://www.convey.ac でアクセスできるウェブサイト CONVEY.ac は、85 Great Portland Street, First Floor, London, W1W7LT に登記上の事務所を置く、英国で登録された私立有限会社である CONVEY Databank Ltd の所有物です。
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        本ウェブサイトは、CONVEY Databank Ltd が開発・管理しており、英国、EU、米国でホスティングを行っています。
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        完全な使用条件は、アカウント作成の際にご覧いただけます。
                    </p>
                    <p style="line-height: 25px!important;">
                        サポート/苦情について。サイト内のお問い合わせフォームをご利用ください。
                    </p>
                </div>
