                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                @if($user_info->business_type=='organisation')
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="JP" name="company_lrd_country">
                                            ...
                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                ...
                                                <option value="{{ $key }}" @if ( $key == "JP" ) selected @endif>{{ $country }}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">メーリング・アドレス - House/Building Number:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">メーリング・アドレス - Street/Road:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_street" value="{{$user_info->ma_street}}" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">メーリング・アドレス - Town/City:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_town_or_city" value="{{$user_info->ma_town_or_city}}" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">メーリング・アドレス - Postcode:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-30  display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            ...
                                            <small style="display: none;" id="company_no_error" class="text-danger">
                                                Must be 13 digits Japan company number at least.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                ...
                                @elseif($user_info->business_type=='selfemployed')
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="JP" name="lrd_country_show">
