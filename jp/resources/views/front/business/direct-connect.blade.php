                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-2 text-right color-black-light display-inline" for="ni">マイナンバー: </label>
                                        <div class="col-md-9 display-inline">
                                    ...
                                    <div class="col-md-12 display-inline">
                                        <label class="col-form-label offset-sm-2 p-3 color-black-light display-inline">
                                            Date of birth and マイナンバー can not be edited.
                                        </label>
                                    </div>
                                    <div class="col-md-12 m-t-30">
...
<script>
    ...
    $('#ni').on('input',function(e) {
        ...
        if(NI_number.search(' ') > 0) {
            ...
            $('#space_error').addClass('filled');
            $('#space_error li').html('The マイナンバー for the Japan is set so it must be at least ' + NI_min_number + ' characters long.');
        } else {
