                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">¥1200<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">¥850 <span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                                            <div class="plan-div-border"></div>
                                        </div>
                                        <div class="plan-features pb-3 mt-3 text-muted padding-t-b-30 line-height-50">
                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">¥400<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                                            <div class="plan-div-border"></div>
                                        </div>
                                        <div class="plan-features pb-3 mt-3 text-muted padding-t-b-30 line-height-50">
                    ...
                    <div class="custom-padding-top">
                        <table id="invoice_table" class="table table-bordered table-striped m-t-40">
                            ...
                            <tr>
                                ...
                                <td class="text-center p-2 download"><a href="{{route('business.invoice_download',['id'=>$item->id])}}" class="text-convey-green">Download</a></td>
                            </tr>
                            <tr>
                                <td class="text-center p-2">Payment Receipt</td>
                                <td class="text-center p-2">{{date_format(date_create($item->date_of_payment),'d/m/Y')}}</td>
                                <td class="text-center p-2 download"><a href="{{route('business.receipt_download',['id'=>$item->id])}}" class="text-convey-green">Download</a></td>
                            </tr>
                            @endforeach
...
@section('script')
<script
    src="https://www.paypal.com/sdk/js?client-id=Af_Ms0n04D2x5xKfjM5sAqVwOKbRPSCFjq-ag1bKUh1-NqQAWFYsxPwV_FMcUsSrFzGlG3JoTuqjW2oh&currency=JPY"> // Required. Replace YOUR_CLIENT_ID with your sandbox client ID.
</script>
<script>
    ...
    $('#credits_history').DataTable({
        ...
        ajax:{
            url: "{{ route('business.search_credits') }}",
            method:'post',
            data:{
