                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" id="user_name" placeholder="お名前">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" class="form-control" id="user_email" placeholder="Eメールアドレス">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" class="form-control" id="user_number" placeholder="お電話番号">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <textarea class="form-control" id="user_message" rows="3" placeholder="メッセージ"></textarea>
                            </div>
                        </div>
...
{{--                            <div style="border: 1px solid #ccc;height: 70px;width: 240px;display: flex;align-items: center;justify-content: center;margin-bottom: 25px;opacity: 0.7;font-size: 24px;text-transform: uppercase;letter-spacing: 2px;cursor: none;">Captcha</div>--}}
                            ...
                            <input type="text" name="captcha_code" id="captcha_code" size="28" maxlength="6" required placeholder="上の和を解いて入力する" style="padding-inline:5px;" autocomplete="off"/>
                            <a href="#" onclick="document.getElementById('captcha').src = '{{url('vendor')}}/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">変更イメージ</a>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
...
{{--                </form>--}}
                <div class="col-md-6">
                    <h4 style="line-height: 160%;">私達はボットを使用しません。送られたメッセージにはきちんとスタッフが回答、お返事いたします。</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-sc">
                    ...
                    <p style="text-align: center;">スタッフは月曜から金曜日、午前9時から午後4時の間で対応いたします。</p>
                </div>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.status == "Message Sent") {
                        ...
                        alertify.success('メッセージが送信されました。');
                    } else {
                        alertify.logPosition("bottom right");
