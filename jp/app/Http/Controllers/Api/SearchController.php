...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $messages = array(
            'National_Number.min' => 'The The マイナンバー for the Japan is set so it must be at least '.$min_num.' characters long.',
        );
                ...
                if(count($max_version) > 0) {
                    foreach ($max_version as $key => $child) {
                        ...
                        if($request->National_Number != 'ABC123456789') {
                            ...
                            $child_record_pattern_array->Record_creators_CBR_id = "JP000000";
...
//                    array_push($item_child, $child_record_pattern_array);
                ...
                if($request->National_Number != 'ABC123456789') {
                    ...
                    $record_pattern_array->Record_creators_CBR_id = "JP000000";
...
//                date_modify($today, "-10 minutes");
    ...
    public function request_departure_evaluation(Request $request)
    {
        ...
        $messages = array(
            'National_Number.min' => 'The マイナンバー for the Japan is set so it must be at least '.$min_num.' characters long.',
