                            ...
                            <div class="card single-faq">
                                ...
                                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <br><br>
                                        <a href="<?php echo e(url('frontend_downloadable_file/press_logo')); ?>" class="color-black-light downloadable-tag">TELECHARGER LES LOGOS<i class="fa fa-download m-lg-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card single-faq">
                                ...
                                <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <br><br>
                                        <a href="<?php echo e(url('frontend_downloadable_file/press_screen_shot')); ?>" class="color-black-light downloadable-tag">TÉLÉCHARGER LES IMAGES<i class="fa fa-download m-lg-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card single-faq">
                                ...
                                <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <br><br>
                                        <a href="<?php echo e(url('frontend_downloadable_file/press_header_images')); ?>" class="color-black-light downloadable-tag">TÉLÉCHARGER LES IMAGES<i class="fa fa-download m-lg-1"></i></a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="business-cta-right-2">
                            <a href="<?php echo e(route('register')); ?>" class=" btn bussiness-btn-larg">METTRE À NIVEAU MAINTENANT</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/fr/resources/views/front/press.blade.php ENDPATH**/ ?>