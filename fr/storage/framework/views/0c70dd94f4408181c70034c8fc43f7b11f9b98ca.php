    ...
    <script>
        $('#NI_search_number').on('input',function(e){
            ...
            if(NI_number.search(' ')>0)
            {
                ...
                $('#space_error').addClass('filled');
                $('#space_error li').html('numéro d\'inscription au répertoire for the France is set so it must be at least ' + NI_min_number + ' characters long.');
            }else{
...
<?php echo $__env->make('layouts.master-advisors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/fr/resources/views/front/advisors/search.blade.php ENDPATH**/ ?>