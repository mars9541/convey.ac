        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            <li><a href="<?php echo e(url('/press')); ?>">Presse</a></li>
                            <li><a href="<?php echo e(url('/brand')); ?>">Guide de la Marque</a></li>
                            <li><a href="<?php echo e(url('/getintouch')); ?>"> Contactez</a></li>
                            <li><a href="javascript:onOpenModal('cookies')"> Cookies</a></li>
                            <li><a href="javascript:onOpenModal('privacy')"> Confidentialité</a></li>
                            <li><a href="javascript:onOpenModal('legal')"> Mentions Légales</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Royaume-Uni">
                                    <span>UK</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="USA">
                                    <span>USA</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ca')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/canada.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Canada">
                                    <span>Canada</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ie')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/ireland.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Irlande">
                                    <span>Irlande</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('au')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/australia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Australie">
                                    <span>Australie</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Espagne">
                                    <span>Espagne</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Allemagne">
                                    <span>Allemagne</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('fr')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/france.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="France">
                                    <span>France</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Italie">
                                    <span>Italie</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Japon">
                                    <span>Japon</span>
                                </a>
                            </li>
...
<div class="modal fade bs-example-modal-lg" id="privacy_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">Politique de confidentialité</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 1.75rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 1rem!important;">Nom de la société : CONVEY Databank Ltd <br>
                        Adresse de la société :  85 Great Portland Street, First Floor, Londres, W1W7LT
                    </p>
                    <p style="margin-bottom: 1rem!important;">
                        Chez CONVEY, nous nous soucions de votre vie privée.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        C'est pourquoi nous ne collectons vos données personnelles que si nous avons une bonne raison de le faire et c'est aussi pourquoi nous voulons communiquer de manière transparente ce que nous faisons avec vos données personnelles. La politique de confidentialité diffère légèrement selon la manière dont vous utilisez CONVEY, par exemple un individu utilisant CONVEY pour trouver des enregistrements sur lui-même aura une politique légèrement différente de celle d'une entreprise utilisant CONVEY pour créer des enregistrements.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Les conditions d'utilisation complètes et pertinentes peuvent être consultées lors du processus de création de compte.
                    </p>
...
<div class="modal fade bs-example-modal-lg" id="legal_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">Mentions Légales</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 2rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 0.7rem!important;">Nom de la société : CONVEY Databank Ltd </p>
                    <p style="margin-bottom: 0.7rem!important;">Adresse de la société :  85 Great Portland Street, First Floor, Londres, W1W7LT </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Le site CONVEY.ac , accessible par l'URL suivant : https://www.convey.ac, est la propriété de CONVEY Databank Ltd, une société privée à responsabilité limitée enregistrée au Royaume-Uni, dont le siège social est situé au 85 Great Portland Street, First Floor, London, W1W7LT.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Le site Web a été développé et est maintenu par CONVEY Databank Ltd, avec un hébergement géographique au Royaume-Uni, dans l'UE et aux États-Unis.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Les conditions d'utilisation complètes sont disponibles lors du processus de création de compte.
                    </p>
                    <p style="line-height: 25px!important;">
                        Pour toute assistance/plainte : Veuillez utiliser le formulaire de contact sur le site.
                    </p>
                </div>
...
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/fr/resources/views/layouts/frontend-footer.blade.php ENDPATH**/ ?>