          ...
          <div id="form_overlay">
            ...
            <div class="loginDetail">
                ...
                <div class="loginDetail-inner " id="step_1">
                    <h2><?php echo e(__('INSCRIVEZ-VOUS MAINTENANT')); ?> <br><span>(ÉTAPE 1 DE 4)</span></h2>
                    ...
                    <select class="form-control" required name="user_type" id="user_type">
                        ...
                        <option value="advisors"> Un pour les consultants/développeurs/conseillers/écrivains</option>
                    ...
                    <div class="col-md-12 test-font-16 hidden" id="advisors_radio">
                        ...
                        <div class="d-inline-block">
                            ...
                            <label class="d-inline" for="bb"> Nous fournissons des conseils aux entreprises</label>
                        </div>
                        <div class="d-inline-block">
                            <input class="d-inline" type="radio" name="advisors_type"  id="cc" value="writer">
                            <label class="d-inline" for="cc"> Nous rédigeons des articles commerciaux</label>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/fr/resources/views/auth/register.blade.php ENDPATH**/ ?>