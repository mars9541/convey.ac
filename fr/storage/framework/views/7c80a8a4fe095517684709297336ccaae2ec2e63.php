                                ...
                                <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="firstname" value="<?php echo e($user_info->firstname); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light" >Last Name:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="lastname" value="<?php echo e($user_info->lastname); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            ...
                                            <div class="input-group">
                                                <input type="date" class="form-control display-inline" placeholder="mm/dd/yyyy" id="datepicker-autoclose" max="9999-12-31"
                                                       <?php if( $user_info->dob_flag >= 1 ): ?> disabled <?php endif; ?> name="DOB" value="<?php echo e($user_info->DOB); ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            <select class="form-control" name="nationality" required>
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>" <?php if( $user_info->nationality == $key ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_HBN" value="<?php echo e($user_info->ma_HBN); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light" >Street/Road:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_street" value="<?php echo e($user_info->ma_street); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light" >Town/City:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_town_or_city" value="<?php echo e($user_info->ma_town_or_city); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                    ...
                    <div class="tab-pane p-3" id="record_settings" role="tabpanel">
                        <div class="table-rep-plugin">
                            ...
                            <form  id="record_settings_from">
                                <div class="table-responsive mb-0" data-pattern="priority-columns">
                                    <div class="col-md-12 m-t-40 display-inline">
                                        <label class="col-form-label col-md-3 text-right color-black-light" for="ni">NIR: </label>
                                        <div class="col-md-8 display-inline">
                                            <input type="text" class="form-control" name="NI_identity_number" id="ni" value="<?php echo e($user_info->NI_identity_number); ?>"
                                                   <?php if( $user_info->ni_flag >= 1 ): ?> disabled <?php endif; ?> />
                                            <div class="">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-8 display-inline">
                                            <input type="text" class="form-control" name="replacement_search_number" id="replacement_search_number" value="<?php echo e($user_info->replacement_search_number); ?>" disabled />
                                            <?php if( $user_info->NI_identity_number != '' ): ?>
                                        ...
                                        <div class="col-md-8 display-inline">
                                            <div class="input-group">
                                                <input type="date" class="form-control" placeholder="mm/dd/yyyy" max="9999-12-31"
                                                       <?php if( $user_info->dob_flag >= 1 ): ?> disabled <?php endif; ?>
                                                       name="DOB" value="<?php echo e($user_info->DOB); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-8 display-inline">
                                            <input type="text" class="form-control" name="record_lock_status" id="record_lock_status"
                                                   <?php if($user_info->record_lock == 0): ?>
                                                   value="UNLOCKED"
                                                   <?php else: ?>
                                                   value="LOCKED"
                                                   <?php endif; ?> disabled />
    ...
    <script>
        ...
        $('#ni').on('input',function(e) {
            ...
            if(NI_number.search(' ') > 0) {
                ...
                $('input[name=NI_identity_number]').css('margin-bottom', '0px');
                $('#space_error').addClass('filled');
                $('#space_error li').html('The numéro d\'inscription au répertoire for the France is set so it must be at least ' + NI_min_number + ' characters long.');
            } else if(NI_number == 'ABC123456789ABC') {
                $('input[name=NI_identity_number]').css('box-shadow', '0px 0px 4px red');
                $('input[name=NI_identity_number]').css('margin-bottom', '0px');
                $('#space_error').addClass('filled');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url:"<?php echo e(route('citizen.auto_save_ni_number')); ?>",
                            method:"POST",
        ...
        {
            $.ajax({
                url:"<?php echo e(route('citizen.generate_replacement_number')); ?>",
                method:"POST",
                data: {
                    item:'example_email',
                },
        ...
        {
            $.ajax({
                url:"<?php echo e(route('citizen.record_lock')); ?>",
                method:"POST",
                data: {
                    lock_flag: lock_flag,
        ...
        $('#update_account').on('submit',function(event){
            ...
            $.ajax({
                url: "<?php echo e(route('citizen.account_settings_update')); ?>",
                method: "POST",
                data: formdata,
                contentType: false,
                cache: false,
        ...
        $('#record_settings_from').on('submit', function(event) {
            ...
            $.ajax({
                url: "<?php echo e(route('citizen.record_settings_update')); ?>",
                method: "POST",
                data: formdata,
                contentType: false,
                cache: false,
        ...
        $('#sample_form').on('submit', function(event){
            ...
            $.ajax({
                url: "<?php echo e(route('citizen.account_details_update')); ?>",
                method: "POST",
...
<?php echo $__env->make('layouts.master-citizen', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/fr/resources/views/front/citizen/settings.blade.php ENDPATH**/ ?>