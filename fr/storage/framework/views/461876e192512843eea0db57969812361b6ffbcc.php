                ...
                <div class="loginDetail">
                    <div class="loginDetail-inner" style="max-width: 440px;">
                        ...
                        <div class="col-sm-12 alert alert-convey-success alert-dismissible fade show text-white" style="background-color: #3BC850;" role="alert">
                            ...
                            <strong>Attention!</strong> <?php echo e($errors->first('email')); ?>
                        ...
                        <input type="email" class="form-control" name="email" placeholder="Saisissez votre adresse e-mail" required value="<?php echo e(old('email')); ?>">
                        ...
                        <a href="#" onclick="document.getElementById('captcha').src = '<?php echo e(url('vendor')); ?>/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">Changer l'image</a>
                    </div>
                </div>
                <div class="loginBottom" style="width: 440px;">
					<button  class="btn btn-primary submitBtn">S'IDENTIFIER</button>
					<a href="<?php echo e(route('login_retrieval')); ?>" class="clickhere text-convey-green" >Cliquez ici pour accéder à vos données</a>
                </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/fr/resources/views/auth/login.blade.php ENDPATH**/ ?>