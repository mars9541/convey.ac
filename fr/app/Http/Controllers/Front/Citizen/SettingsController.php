...
class SettingsController extends Controller
{
    ...
    function random_strings()
    {
        ...
        $return_strings = substr(str_shuffle($str_letters), 0, 8).substr(str_shuffle($str_numbers), 0, 7);
    ...
    public function auto_save_ni_number(Request $request)
    {
        ...
        return response()->json(['success' => 'NIR is successfully saved', 'ni_flag' => $ni_flag]);
    }
