...
//////// employees ////////////
    ...
    public function employee_add(Request $request)
    {
        ...
        $messages = array(
            'NI_Insurance_Number.min' => 'The numéro d\'inscription au répertoire for the France is set so it must be at least '.$min_num.' characters long.',
        );
        ...
        if($request->NI_Insurance_Number == 'ABC123456789ABC')
