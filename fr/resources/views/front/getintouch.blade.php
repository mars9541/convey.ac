            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="business-title-middle">
                        <h2>Contactez-nous et parlons-en...</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" id="user_name" placeholder="Votre prénom et votre nom">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" class="form-control" id="user_email" placeholder="Votre e-mail">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" class="form-control" id="user_number" placeholder="Numéro de téléphone">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <textarea class="form-control" id="user_message" rows="3" placeholder="Votre message"></textarea>
                            </div>
                        </div>
...
{{--                            <div style="border: 1px solid #ccc;height: 70px;width: 240px;display: flex;align-items: center;justify-content: center;margin-bottom: 25px;opacity: 0.7;font-size: 24px;text-transform: uppercase;letter-spacing: 2px;cursor: none;">Captcha</div>--}}
                            ...
                            <input type="text" name="captcha_code" id="captcha_code" size="28" maxlength="6" required placeholder="Résolvez et entrez la somme ci-dessus" style="padding-inline:5px;" autocomplete="off"/>
...
{{--                </form>--}}
                <div class="col-md-6">
                    <h4 style="line-height: 160%;">Notre équipe est 100% humaine (pas de robots) et toujours prête à répondre à vos questions</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-sc">
                    ...
                    <p style="text-align: center;">Le personnel est disponible de 9h à 16h du lundi au vendredi</p>
                </div>
            </div>
        </div>
    </div>
