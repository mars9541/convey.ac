    ...
    <div class="col-md-12">
        <div id="form_overlay">
            <div class="form_overlay_message">
                <a href="{{url('/')}}"><img src="{{asset('front')}}/images/logo-dark.png" alt="logo" height="50"></a>
            ...
            <div class="tab-content">
                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-2 text-right color-black-light display-inline" for="ni">NIR: </label>
                                        <div class="col-md-9 display-inline">
                                    ...
                                    <div class="col-md-12 display-inline">
                                        <label class="col-form-label offset-sm-2 p-3 color-black-light display-inline">
                                            Date of birth and NIR can not be edited.
                                        </label>
                                    </div>
                                    <div class="col-md-12 m-t-30">
                            ...
                            <div class="card m-b-20" id="create_tem_tab" style="display: none;">
                                <div class="card-body">
                                    ...
                                    <form method="post" id="record_type_form" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        {{--<div class="test-font-16 text-center m-t-30">
                                            <div class="col-md-12 row">
                                                <label class="col-form-label text-left offset-2" for="record_logo">Step 1.Do you want to add your logo to the printable version of this template, if so upload it here:</label>
                                            </div>
                                            <div class="col-md-12 row text-center">
                                                <div class="col-md-4">
                                                </div>
                                                <div class="col-md-5">
                                                    <input type="file" class="text-left" name="record_logo" id="record_logo" style="margin-left: 1em;" accept=".png, .jpg, .jpeg, .gif"/>
                                                    <img src="#" id="record_logo_image" width="100px" style="display: none;">
                                                </div>
                ...
                <div class="tab-pane p-3" id="record_history" role="tabpanel">
                    <div class="table-rep-plugin">
                        ...
                        {{--<div class="col-md-6 float-right text-right mt-3">
                            <p class="mb-0 color-black-light">
                                <i class="ion-eye"></i>: View &nbsp;&nbsp;
                                <i class="ion-edit"></i>: Edit
                            </p>
...
var m_draft_flag = 0;
    ...
    function first_load() {
        ...
        $.ajax({
            url: "{{ route('business.get_employees') }}",
            method: "POST",
            dataType: "json",
            success: function (html) {
                $('#employees').empty();
                ...
                $.ajax({
                    url: "{{ route('business.get_record_types') }}",
                    method: "POST",
                    dataType: "json",
                    success: function (html) {
                        if (html.data.length > 0) {
                        ...
                        $.ajax({
                            url: "{{ route('business.get_draft_data') }}",
                            method: "POST",
                            dataType: "json",
                            success: function (res) {
                                if (res.length > 0) {
                                    ...
                                    if (record_type == 0) {
                                        ...
                                        $.ajax({
                                            url: "{{ route('business.get_qa_type_info') }}",
                                            method: "POST",
                                            data:
                                                {
    ...
    $('#clear_exit').on('click', function () {
        ...
        $.ajax({
            url:"{{ route('business.clear_draft') }}",
            method:"POST",
            dataType:"json",
            success:function(data)
            {
    ...
    */
    function add_question_info(question_id) {
        if(question_id == 0) {
            ...
            $.ajax({
                url:"{{route('business.get_current_question_info')}}",
                method:"POST",
                data: {
    ...
    $('#btn_save_question').on('click', function () {
        ...
        $.ajax({
            url:"{{route('business.save_question')}}",
            method:"POST",
            data: {
    ...
    $('#record_type_table').DataTable({
        ...
        autoWidth: false,
        ajax:{
            url: "{{ route('business.record_type_list') }}",
            method:'post',
            data:{
                        ...
                        if(row.priority == '1') {
                            if(row.type_mode == '0') {
                                return '<a href="javascript:visible_record_type(\''+data+'\',4)" title="Visible" class="text-dark"><i class="fa fa-unlock"></i></a> | ' +
                                        '<a href="{{url("business/recordTemplateDownload")}}/'+data+'" title="Print" class="text-dark"><i class="ion-printer"></i></a>';
                            } else {
    ...
    $('#type_mode_table').DataTable({
        ...
        autoWidth: false,
        ajax:{
            url: "{{ route('business.record_type_mode_list') }}",
            method:'post',
            data:{
    ...
    function order_down(id) {
        $.ajax({
            url:"{{url('business/order_down')}}/" + id,
            dataType:"json",
            success:function(data) {
                if(data.success)
                {
    ...
    function delete_question(id) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url:"{{url('business/delete_question')}}/" + id,
                    dataType:"json",
                    success:function(data){
                        var html = '';
                        if(data.success)
    ...
    $('#record_type_form').on('submit', function(event) {
        ...
        {
            $.ajax({
                url:"{{ route('business.record_type_add') }}",
                method:"POST",
        ...
        {
            $.ajax({
                url: "{{ route('business.record_type_update') }}",
                method: "POST",
                data: new FormData(this),
                contentType: false,
                cache: false,
    ...
    function edit_record_type(id) {
        ...
        $.ajax({
            url:"{{url('business/get_record_type')}}/" + id,
            dataType:"json",
            success:function(html) {
    ...
    function visible_record_type(id, priority){
        $.ajax({
            url:"{{route('business.visible_record_type')}}",
            method: 'post',
            data: {
                id: id,
                priority,priority
    ...
    function delete_record_type(id) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('business/delete_record_type')}}/" + id,
                    dataType: "json",
                    success: function(data){
                        var html = '';
...
<script>
    ...
    $('#employees_table').DataTable({
        ...
        autoWidth: false,
        ajax:{
            url: "{{ route('business.employee_list') }}",
            method: 'post',
            data: {
                    _token: $('meta[name="_token"]').attr('content')
            }
    ...
    $('#employee_form').on('submit', function(event) {
        ...
        {
            $.ajax({
                url:"{{ route('business.employee_add') }}",
                method:"POST",
                data: new FormData(this),
                contentType: false,
                cache:false,
        ...
        {
            $.ajax({
                url:"{{ route('business.employee_update') }}",
                method:"POST",
                data:new FormData(this),
                contentType: false,
                cache: false,
    ...
    function edit_employee(id) {
        $('#e_form_result').html('');
        $.ajax({
            url: "{{url('business/get_employee')}}/" + id,
            dataType: "json",
            success: function(html) {
    ...
    function delete_employee(id){
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('business/delete_employee')}}/" + id,
                    dataType: "json",
                    success: function(data) {
                        var html = '';
                        if(data.success)
...
<script>
    $('#record_history_table').DataTable({
        ...
        searching: false,
        ajax:{
            url: "{{ route('business.record_history_list') }}",
            method: 'post',
            data: function ( d ) {
                        ...
                        if(row.max_version == 'yes') {
                            if(row.full_name == "Employee Off-boarded") {
                                return '<a href="javascript:view_record(\''+data+'\')" class="text-dark" title="View"><i class="ion-eye"></i></a> | ' +
                                    '<a href="{{url("business/recordHistoryDownload")}}/'+data+'" title="Print" class="text-dark"><i class="ion-printer"></i></a>';
                            } else {
                                return '<a href="javascript:view_record(\''+data+'\')" class="text-dark" title="View"><i class="ion-eye"></i></a> | ' +
    ...
    {
        $.ajax({
            url: "{{url('business/get_record_history_content')}}/" + id,
            dataType: "json",
            success:function(html) {
