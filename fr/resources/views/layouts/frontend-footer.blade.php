                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            ...
                            <li><a href="{{url('/brand')}}">Guide de la Marque</a></li>
                            <li><a href="{{url('/getintouch')}}"> Contactez</a></li>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="{{asset('landing_front')}}/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Royaume-Uni">
                                    <span>UK</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="{{asset('landing_front')}}/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="USA">
                                    <span>USA</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ca')">
                                    <img src="{{asset('landing_front')}}/images/country/canada.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Canada">
                                    <span>Canada</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ie')">
                                    <img src="{{asset('landing_front')}}/images/country/ireland.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Irlande">
                                    <span>Irlande</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('au')">
                                    <img src="{{asset('landing_front')}}/images/country/australia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Australie">
                                    <span>Australie</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="{{asset('landing_front')}}/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Espagne">
                                    <span>Espagne</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="{{asset('landing_front')}}/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Allemagne">
                                    <span>Allemagne</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('fr')">
                                    <img src="{{asset('landing_front')}}/images/country/france.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="France">
                                    <span>France</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="{{asset('landing_front')}}/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Italie">
                                    <span>Italie</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="{{asset('landing_front')}}/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Japon">
                                    <span>Japon</span>
                                </a>
                            </li>
                            {{--<li class="float-none">
                                <a onclick="onCountrySite('ru')">
                                    <img src="{{asset('landing_front')}}/images/country/russia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Russie">
                                    <span>Russie</span>
                                </a>
                            </li>--}}
                        </ul>
