                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light btco-hover-menu">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto business-nav left-nav hidden-lg hidden-md hidden-sm hidden-xs mr-4">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/')}}">Aperçu</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/benefits')}}">Avantages</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/price')}}">Prix</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/secure')}}">Sécurisé</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/upgrade')}}">Mise à niveau</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/more')}}">PLUS</a>
                                </li>
                            </ul>
                            ...
                            <ul class="navbar-nav ml-auto right-nav business-nav">
                                ...
                                <li class="nav-item hidden-md hidden-sm hidden-xs">
                                    <a class="nav-link d-inline-flex align-items-center" href="javascript:void(0)" >
                                        ...
                                        <img id="img_country" src="{{asset('landing_front')}}/images/country/france.png" style="width: 20px; height: 20px;" alt="France">
                                    ...
                                    <ul class="cntry">
                                        ...
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('england', 'gb')">
                                                <img src="{{asset('landing_front')}}/images/country/england.png" width="30px" alt="Royaume-Uni">
                                        ...
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('ireland', 'ie')">
                                                <img src="{{asset('landing_front')}}/images/country/ireland.png" width="30px" alt="Irlande">
                                        ...
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('australia', 'au')">
                                                <img src="{{asset('landing_front')}}/images/country/australia.png" width="30px" alt="Australie">
                                        ...
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('germany', 'de')">
                                                <img src="{{asset('landing_front')}}/images/country/germany.png" width="30px" alt="Allemagne">
                                                <span class="cnt-spn">Allemagne</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('spain', 'es')">
                                                <img src="{{asset('landing_front')}}/images/country/spain.png" width="30px" alt="Espagne">
                                                <span class="cnt-spn">Espagne</span>
                                            </a>
                                        </li>
                                        {{--<li>
                                            <a class="country-class" onclick="onSelectCountry('russia', 'ru')">
                                                <img src="{{asset('landing_front')}}/images/country/russia.png" width="30px" alt="Russie">
                                                <span class="cnt-spn">Russie</span>
                                            </a>
                                        </li>--}}
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('italy', 'it')">
                                                <img src="{{asset('landing_front')}}/images/country/italy.png" width="30px" alt="Italie">
                                                <span class="cnt-spn">Italie</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('japan', 'jp')">
                                                <img src="{{asset('landing_front')}}/images/country/japan.png" width="30px" alt="Japon">
                                ...
                                <li class="nav-item lgin-sgn-item">
                                    <a class="nav-link" id="a_login" href="{{route('login')}}">Connexion</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="a_signup" href="{{route('register')}}">
