            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="business-title-middle">
                        <h2>Kontaktieren Sie uns & lassen Sie uns miteinander reden...</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" id="user_name" placeholder="Ihr Name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" class="form-control" id="user_email" placeholder="Ihre E-Mail">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" class="form-control" id="user_number" placeholder="Telefon Nummer">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <textarea class="form-control" id="user_message" rows="3" placeholder="Ihre Nachricht"></textarea>
                            </div>
                        </div>
...
{{--                            <div style="border: 1px solid #ccc;height: 70px;width: 240px;display: flex;align-items: center;justify-content: center;margin-bottom: 25px;opacity: 0.7;font-size: 24px;text-transform: uppercase;letter-spacing: 2px;cursor: none;">Captcha</div>--}}
                            ...
                            <input type="text" name="captcha_code" id="captcha_code" size="28" maxlength="6" required placeholder="Lösen Sie die obige Summe und geben Sie sie ein" style="padding-inline:5px;" autocomplete="off"/>
                            <a href="#" onclick="document.getElementById('captcha').src = '{{url('vendor')}}/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">Bild ändern</a>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
...
{{--                </form>--}}
                <div class="col-md-6">
                    <h4 style="line-height: 160%;">Unser Team besteht zu 100% aus Menschen (keine Bots) und ist immer bereit, Ihre Fragen zu beantworten</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-sc">
                    ...
                    <p style="text-align: center;">Teammitglieder sind von Montag bis Freitag von 9-4 Uhr erreichbar</p>
                </div>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.status == "Message Sent") {
                        ...
                        alertify.success('Nachricht gesendet!');
                    } else {
                        alertify.logPosition("bottom right");
