                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light btco-hover-menu">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto business-nav left-nav hidden-lg hidden-md hidden-sm hidden-xs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/benefits')}}">Vorteile</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/price')}}">Preis</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/secure')}}">Sicherheit</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/upgrade')}}">Upgraden</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/more')}}">MEHR</a>
                                </li>
                            </ul>
                            ...
                            <ul class="navbar-nav ml-auto right-nav business-nav">
                                ...
                                <li class="nav-item hidden-md hidden-sm hidden-xs">
                                    <a class="nav-link d-inline-flex align-items-center" href="javascript:void(0)" >
                                        ...
                                        <img id="img_country" src="{{asset('landing_front')}}/images/country/germany.png" style="width: 20px; height: 20px;" alt="Germany">
                                    ...
                                    <ul class="cntry">
                                        ...
                                        {{--<li>
                                            <a class="country-class" onclick="onSelectCountry('russia', 'ru')">
                                                ...
                                                <span class="cnt-spn">Russland</span>
                                            </a>
                                        </li>--}}
                                        <li>
                                ...
                                <li class="nav-item lgin-sgn-item">
                                    <a class="nav-link" id="a_login" href="{{route('login')}}">Anmeldung</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" style="padding-right: 1px!important; padding-left: 0px!important;" id="a_signup" href="{{route('register')}}">
