                ...
                <div class="loginDetail">
                    <div class="loginDetail-inner" style="max-width: 440px;">
                        ...
                        <div class="col-sm-12 alert alert-convey-success alert-dismissible fade show text-white" style="background-color: #3BC850;" role="alert">
                            ...
                            <strong>Warnung!</strong> {{ $errors->first('email') }}
                        </div>
                        @endif
                        ...
                        <input type="email" class="form-control" name="email" placeholder="Geben Sie Ihre E-Mail Adresse ein" required value="{{old('email')}}">
                        ...
                        <a href="#" onclick="document.getElementById('captcha').src = '{{url('vendor')}}/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">Ändern Sie das Bild</a>
                    </div>
                </div>
                <div class="loginBottom" style="width: 440px;">
					<button  class="btn btn-primary submitBtn">ANMELDEN</button>
					<a href="{{route('login_retrieval')}}" class="clickhere text-convey-green" >Klicken Sie hier, um Ihre Daten abzurufen</a>
                </div>
                </form>
            </div>
        </div>
