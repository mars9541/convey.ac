                        ...
                        <div class="form-group row">
                            ...
                            <?php else: ?>
                                <label class="col-lg-12 text-center font-20 col-form-label color-black-light">
                                    To view your last record please go to your settings page and enter your Sozialversicherungsnummer
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-12">
                                    <div class="card m-b-20 box-shadow-note">
                                        <div class="card-body custom-padding-btop text-center">
                                            <span
                                                class="card-title font-20 mt-0 align-middle font-weight-bolder color-black-light text-center"><?php echo e($record->NI_identity_number); ?></span>
                                        </div>
                                        <div class="card-body color-black-light">
                                            <p class="font-20 mt-0 align-middle">Created By:
                                                <strong><?php echo e($record->business_name); ?> </strong></p>
                                            <p class="ard-title font-20 mt-0 align-middle">Type of record:
                                                <strong><?php echo e($record->record_type); ?></strong></p>
                                            <p class="ard-title font-20 mt-0 align-middle">Data created:
                                                <strong><?php echo e(date_format(date_create($record->time_stamp),'Y-m-d')); ?></strong>
                                            </p>
                                            <span class="card-title font-20 mt-0 align-middle">Comments:</span>
                                            <div
                                                class="color-black-light font-20 pl-5 mt-3"><?php echo $record->RECORD_content; ?></div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master-citizen', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/de/resources/views/front/citizen/last-record.blade.php ENDPATH**/ ?>