            ...
            <script>
                ...
                function on_sent_request_click() {
                    ...
                    if(NI_number == '') {
                        ...
                        $('#gov_number_required').html('The SSN Number for the Germany is set so it must be at least ' + '<?php echo e($NI_min_number); ?>' + ' characters long.');
                        error_detect = 1;
                    } else {
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/de/resources/views/front/business/search.blade.php ENDPATH**/ ?>