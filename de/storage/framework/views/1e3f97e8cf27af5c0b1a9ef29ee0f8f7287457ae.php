          ...
          <div id="form_overlay">
            ...
            <div class="loginDetail">
                ...
                <div class="loginDetail-inner " id="step_1">
                    <h2><?php echo e(__('JETZT ANMELDEN')); ?> <span>(SCHRITT 1 VON 4)</span></h2>
                    ...
                    <select class="form-control" required name="user_type" id="user_type">
                        ...
                        <option value="advisors"> Eines für Berater/Entwickler/Berater/Schriftsteller</option>
                    ...
                    <div class="col-md-12 test-font-16 hidden" id="advisors_radio">
                        ...
                        <div class="d-inline-block">
                            ...
                            <label class="d-inline" for="bb"> Wir bieten Business-Beratung</label>
                        </div>
                        <div class="d-inline-block">
                            <input class="d-inline" type="radio" name="advisors_type"  id="cc" value="writer">
                            <label class="d-inline" for="cc"> Wir schreiben Business-Artikel</label>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/de/resources/views/auth/register.blade.php ENDPATH**/ ?>