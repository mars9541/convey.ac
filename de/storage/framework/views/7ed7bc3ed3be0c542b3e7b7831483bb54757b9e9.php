                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/basiclogo.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    <div class="col-md-8">
                        <div class="about-business-left-2x">
                            ...
                            <p>Idealerweise sollte unser Logo immer vollfarbig dargestellt werden. Wir verstehen jedoch, dass Sie unser Logo manchmal einfarbig verwenden müssen. Die hier gezeigten Beispiele zeigen, wie unser Logo unter verschiedenen Bedingungen aussehen sollte. Laden Sie unsere Logos hier herunter:
                                <br><br>&nbsp&nbsp&nbsp&nbsp<a href="<?php echo e(url('frontend_downloadable_file/convey_colour_logo')); ?>" class="color-black-light downloadable-tag">Farbiges Logo</a>&nbsp&nbsp|&nbsp&nbsp <a href="<?php echo e(url('frontend_downloadable_file/convey_black_logo')); ?>" class="color-black-light downloadable-tag">Schwarz auf Weiß Logo</a>&nbsp&nbsp|&nbsp&nbsp <a href="<?php echo e(url('frontend_downloadable_file/convey_white_logo')); ?>" class="color-black-light downloadable-tag">Weiß auf Schwarz Logo</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/appearance.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/spacing.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/unacceptable.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/colours.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/de/resources/views/front/brand.blade.php ENDPATH**/ ?>