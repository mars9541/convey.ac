    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li><a href="<?php echo e(url('advisors/search')); ?>" class="waves-effect <?php echo e(Auth::user()->advisors_type != 'developer' ? "" : "d-none"); ?>"><i class="mdi mdi-magnify"></i><span> Search </span></a></li>
                <li><a href="<?php echo e(url('advisors/search-credits')); ?>" class="waves-effect <?php echo e(Auth::user()->advisors_type != 'developer' ? "" : "d-none"); ?>"><i class="mdi mdi-account-search"></i><span> Search Credits </span></a></li>
...
<!-- Left Sidebar End -->
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/de/resources/views/layouts/sidebar_advisors.blade.php ENDPATH**/ ?>