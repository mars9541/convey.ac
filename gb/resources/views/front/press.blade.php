                            ...
                            <div class="card single-faq">
                                ...
                                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <br><br>
                                        <a href="{{url('frontend_downloadable_file/press_logo')}}" class="color-black-light downloadable-tag">DOWNLOAD LOGOS<i class="fa fa-download m-lg-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card single-faq">
                                ...
                                <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <br><br>
                                        <a href="{{url('frontend_downloadable_file/press_screen_shot')}}" class="color-black-light downloadable-tag">DOWNLOAD IMAGES<i class="fa fa-download m-lg-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card single-faq">
                                ...
                                <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <br><br>
                                        <a href="{{url('frontend_downloadable_file/press_header_images')}}" class="color-black-light downloadable-tag">DOWNLOAD IMAGES<i class="fa fa-download m-lg-1"></i></a>
                                    </div>
                                </div>
                            </div>
