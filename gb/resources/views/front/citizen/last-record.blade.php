                        ...
                        <div class="form-group row">
                            ...
                            @else
                                <label class="col-lg-12 text-center font-20 col-form-label color-black-light">
                                    To view your last record please go to your settings page and enter your National
                                    Insurance number. If you already have then no records currently exist.</label>
                            @endif
                        </div>
