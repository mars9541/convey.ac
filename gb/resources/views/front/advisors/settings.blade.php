                                ...
                                <div class="col-md-12 m-t-15 display-inline">
                                    ...
                                    <div class="col-md-7  display-inline">
                                        <div class="input-group ">
                                            <input type="date" class="form-control display-inline" placeholder="mm/dd/yyyy" max="9999-12-31" id="datepicker-autoclose" name="lrd_DOB" value="{{$user_info->lrd_DOB}}" required>
