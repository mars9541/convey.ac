...
<script>
    ...
    $('#record_history_table').DataTable({
        ...
        autoWidth: false,
        ajax:{
            url: "{{ route('business.get_api_record_list') }}",
            method:'post',
            data:{
    ...
    $('#record_errors_table').DataTable({
        ...
        autoWidth: false,
        ajax:{
            url: "{{ route('business.get_api_record_error_list') }}",
            method:'post',
            data:{
                _token: $('meta[name="_token"]').attr('content')
            }
    ...
    {
        $.ajax({
            url:"{{url('business/get_api_record_info')}}/"+id,
            dataType:"json",
    ...
    {
        $.ajax({
            url:"{{url('business/del_api_record')}}/"+id,
            dataType:"json",
            success:function(html){
