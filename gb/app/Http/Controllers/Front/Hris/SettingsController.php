...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('front.hris.settings', compact('user_info','market','countries','freeEmailList', 'email_verify'));
    }
    ...
    public function country_access()
    {
        ...
        return view('front.hris.country-access', compact('country_list', 'country_info', 'active_flag'));
    }
