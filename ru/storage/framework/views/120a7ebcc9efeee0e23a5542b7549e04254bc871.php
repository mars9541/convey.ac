            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" class="form-control" id="user_email" placeholder="Адрес электронной почты">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" class="form-control" id="user_number" placeholder="Номер телефона">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <textarea class="form-control" id="user_message" rows="3" placeholder="Ваше сообщение"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mt-1">

                            <img id="captcha" src="<?php echo e(url('vendor')); ?>/securimage/securimage_show.php" alt="CAPTCHA Image" />
                            <input type="text" name="captcha_code" id="captcha_code" size="28" maxlength="6" required placeholder="Решите и введите приведенную выше сумму" style="padding-inline:5px;" autocomplete="off"/>
                ...
                <div class="col-md-6">
                    <h4 style="line-height: 160%;">Наша команда на 100% состоит из людей (без ботов), которые с радостью ответят на ваши вопросы</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-sc">
                    ...
                    <p style="text-align: center;">Обращайтесь к ним с 9 до 16 с понедельника по пятницу</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="business-cta-right-2">
                            <a href="<?php echo e(route('register')); ?>" class=" btn bussiness-btn-larg">ОБНОВИТЬ СЕЙЧАС</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/ru/resources/views/front/getintouch.blade.php ENDPATH**/ ?>