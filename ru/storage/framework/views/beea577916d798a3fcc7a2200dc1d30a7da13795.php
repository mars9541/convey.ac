                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form id="update_account">
                                ...
                                <div class="col-md-12 m-t-30 display-inline">
                                    ...
                                    <a href="<?php echo e(url('public/upload')); ?>/<?php echo e($user_info->hris_guide); ?>" class="display-inline" target="_blank"><img src="<?php echo e(asset('assets/images/pdf.png')); ?>" width="50px"></a>
                                    <?php endif; ?>
                                    <label class="col-form-label offset-2 text-right color-black-light">This step by step guide will be shown to users so they know how to access the convey DATABANK using your systems.</label>
                                </div>
                                <div class="col-md-12 m-t-30 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="RU" name="company_lrd_country">
                                            ...
                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                ...
                                                <option value="<?php echo e($key); ?>" <?php if( $key == "RU" ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    ...
    function account_settings_update(update_flag = null) {
        var website_url = $('input[name=website]').val();
        var url_array = website_url.split(' ');
        var password = $('#password').val();
        var error_detect = 0;
        ...
        if(update_flag != null) {
            if ($("#hris_guide").val() == '') {
                alert('Please upload the user guide.');
                return false;
            }
        }
        <?php endif; ?>
    ...
    $('#list_service').on('click', function(event) {
        ...
        if($('#list_service').text().indexOf('List Service') >= 0) {
            account_settings_update('hris_list_service');
        }
    })
...
<?php echo $__env->make('layouts.master-hris', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/ru/resources/views/front/hris/settings.blade.php ENDPATH**/ ?>