        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            <li><a href="<?php echo e(url('/brand')); ?>">Руководство по бренду</a></li>
                            <li><a href="<?php echo e(url('/getintouch')); ?>"> Контакты</a></li>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="CK">
                                    <span>CK</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="США">
                                    <span>США</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ca')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/canada.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Канада">
                                    <span>Канада</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ie')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/ireland.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Ирландия">
                                    <span>Ирландия</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('au')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/australia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Австралия">
                                    <span>Австралия</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Испания">
                                    <span>Испания</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Германия">
                                    <span>Германия</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('fr')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/france.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Франция">
                                    <span>Франция</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Италия">
                                    <span>Италия</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Япония">
                                    <span>Япония</span>
                                </a>
                            </li>
...
<?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/ru/resources/views/layouts/frontend-footer.blade.php ENDPATH**/ ?>