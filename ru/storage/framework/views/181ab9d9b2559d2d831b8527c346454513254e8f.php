                    ...
                    <form class="" action="#">
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="num-green-circle display-inline" id="div_credit"><?php echo e($credit); ?></div>
                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">₽750<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">₽550<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                                            <div class="plan-div-border"></div>
                                        </div>
                                        <div class="plan-features pb-3 mt-3 text-muted padding-t-b-30 line-height-50">
                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">₽250<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                                            <div class="plan-div-border"></div>
                                        </div>
                                        <div class="plan-features pb-3 mt-3 text-muted padding-t-b-30 line-height-50">
                ...
                <div class="tab-pane p-3" id="invoices" role="tabpanel">
                    <div class="custom-padding-top">
                        <table id="invoice_table" class="table table-bordered table-striped m-t-40">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $invoices_paymentreceipt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-center p-2">Invoice</td>
                                <td class="text-center p-2"><?php echo e(date_format(date_create($item->date_of_payment),'d/m/Y')); ?></td>
                                <td class="text-center p-2 download"><a href="<?php echo e(route('business.invoice_download',['id'=>$item->id])); ?>" class="text-convey-green">Download</a></td>
                            </tr>
                            <tr>
                                <td class="text-center p-2">Payment Receipt</td>
                                <td class="text-center p-2"><?php echo e(date_format(date_create($item->date_of_payment),'d/m/Y')); ?></td>
                                <td class="text-center p-2 download"><a href="<?php echo e(route('business.receipt_download',['id'=>$item->id])); ?>" class="text-convey-green">Download</a></td>
                            </tr>
...
<form action="<?php echo e(route('business.buy_credits')); ?>" method="post" style="display: none" id="buy_credits_form">
    <?php echo csrf_field(); ?>
...
<script
    src="https://www.paypal.com/sdk/js?client-id=ASjVB3pxSzs8qUGGuJEO-tWbgKimhM-rtDPy17aAihSPW2ZEew-N90-KOu1InahNzNCO6Z20F7A0FU2O&currency=RUB"> // Required. Replace YOUR_CLIENT_ID with your sandbox client ID.
</script>
<script>
    ...
    function buy_credits(package_type, details)
    {
        ...
        $.ajax({
            url:"<?php echo e(route('business.paypal_buy_credits')); ?>",
            method:"POST",
            data:formData,
            cache: false,
            contentType: false,
            ...
            success:function(html){
                // console.log(html);
                // $('#show_redirect').show();
                window.location = "<?php echo e(route('business.search-credits')); ?>";
    ...
    function get_purchase_amount(package_number) {
        ...
        $.ajax({
            url:"<?php echo e(route('business.get_purchase_amount')); ?>",
            method:"POST",
            data:formData,
            cache: false,
            contentType: false,
    ...
    $('#credits_history').DataTable({
        ...
        ajax:{
            url: "<?php echo e(route('business.search_credits')); ?>",
            method:'post',
            data:{
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/ru/resources/views/front/business/search-credits.blade.php ENDPATH**/ ?>