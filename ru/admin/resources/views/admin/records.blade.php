            ...
            <div class="tab-content">
                <div class="tab-pane active p-3" id="search_view" role="tabpanel">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" required placeholder="Enter INN:" id="NI_search_number" />
                    ...
                    <div class="card-body custom-padding-btop ">
                        ...
                        <ul>
                            <li class="card-title mt-0 color-black-light">
                                3 records added for 1 INN by different users in any 6 month period.
                            </li>
                            <li class="card-title mt-0 color-black-light">
...
<div class="modal fade" id="test_data_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Edit Test INN</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="example-text-input" class="col-sm-4 col-form-label">INN</label>
                    <div class="col-sm-8">
