        ...
        <div class="container login-container">
            <div class="loginPage loginForm">
                ...
                <div class="loginDetail">
                    <div class="loginDetail-inner" style="max-width: 440px;">
                        ...
                        <div class="col-sm-12 alert alert-convey-success alert-dismissible fade show text-white" style="background-color: #3BC850;" role="alert">
                            ...
                            <strong>Внимание!</strong> {{ $errors->first('email') }}
                        </div>
                        @endif
                        ...
                        <input type="email" class="form-control" name="email" placeholder="Введите ваш адрес электронной почты" required value="{{old('email')}}">
                ...
                <div class="loginBottom" style="width: 440px;">
					...
					<a href="{{route('login_retrieval')}}" class="clickhere text-convey-green" >Нажмите здесь, чтобы восстановить ваши данные</a>
                </div>
                </form>
            </div>
        </div>
