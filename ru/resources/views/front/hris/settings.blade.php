                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form id="update_account">
                                ...
                                <div class="col-md-12 m-t-30 display-inline text-center">
                                    ...
                                    <input type="radio" name="hris_type" value="software" id="a" {{$user_info->hris_type=='software'?'checked':''}}>
                                    <label class="col-form-label col-md-2 text-left color-black-light" for="a">HRIS software only </label>

                                    <input type="radio" name="hris_type" value="tracking" id="b" {{$user_info->hris_type=='tracking'?'checked':''}}>
                                    <label class="col-form-label col-md-3 text-left color-black-light" for="b">ATS or VMS Software Only</label>

                                    <input type="radio" name="hris_type" value="both" id="c" {{$user_info->hris_type=='both'?'checked':''}}>
                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                @if($user_info->business_type=='organisation')
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="RU" name="company_lrd_country">
                                            ...
                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                ...
                                                <option value="{{ $key }}" @if ( $key == "RU" ) selected @endif>{{ $country }}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Почтовый адрес - House/Building Number:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Почтовый адрес - Street/Road:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_street" value="{{$user_info->ma_street}}" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Почтовый адрес - Town/City:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_town_or_city" value="{{$user_info->ma_town_or_city}}" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Почтовый адрес - Postcode:</label>
                                        <div class="col-md-7 display-inline">
                                ...
                                @elseif($user_info->business_type=='company')
                                    ...
                                    <div class="col-md-12 m-t-30  display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            ...
                                            <small style="display: none;" id="company_no_error" class="text-danger">
                                                Must be a 10 digit Russian INN at least.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Director - House/Building Number:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_HBN" value="{{$user_info->ma_HBN}}" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Director - Street/Road:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_street" value="{{$user_info->ma_street}}" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Director - Town/City:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_town_or_city" value="{{$user_info->ma_town_or_city}}" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Director - Postcode:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_postcode" value="{{$user_info->ma_postcode}}" />
                                        </div>
                                    </div>
                                ...
                                @elseif($user_info->business_type=='selfemployed')
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="RU" name="lrd_country_show">
                            ...
                            <form id="form_list_service">
                                ...
                                <div class="col-md-12 m-t-5 display-inline">
                                    <div class="border pt-3 pb-1">
                                        ...
                                        @if(!is_null($user_info->hris_guide))
                                            <a href="{{url('public/upload')}}/{{$user_info->hris_guide}}" id="a_hris_guide" class="display-inline" target="_blank"><img src="{{asset('assets/images/pdf.png')}}" width="50px"></a>
                                        @else
                                ...
                                <div class="col-md-12 m-t-5 display-inline">
                                    <div class="border pt-3 pb-1">
                                        ...
                                        @if(!is_null($user_info->Logo))
                                            <img src="{{url('public/upload')}}/{{$user_info->Logo}}" id="logo_image" alt="your image" width="100px">
                                        @else
                                ...
                                <div class="col-md-12 m-t-5 display-inline">
                                    <div class="border pt-3 pb-1">
                                        ...
                                        <div class="col-md-9 display-inline">
                                            <input type="email" class="form-control" name="tech_email" id="tech_email" value="{{$user_info->tech_email}}" />
                                        </div>
                                        <div class="offset-2 col-md-10 display-inline">
                                        ...
                                        <div class="col-md-9 display-inline">
                                            <input type="email" class="form-control" name="pr_email" id="pr_email" value="{{$user_info->pr_email}}" />
                                        </div>
                                        <div class="offset-2 col-md-10 display-inline">
...
<script>
    ...
    function update_list_service(update_flag = null) {
        ...
        $.ajax({
            url: "{{ route('settings.update_hris_list_service') }}",
            method: "POST",
            data: form_data,
            contentType: false,
            cache: false,
