            ...
            <script>
                $('#NI_search_number').on('input',function(e){
                    ...
                    if(NI_number.search(' ')>0)
                    {
                        ...
                        $('#space_error').addClass('filled');
                        $('#space_error li').html('The INN Number for the Russia is set so it must be at least ' + NI_min_number + ' characters long.');
                    }else{
                ...
                function on_sent_request_click() {
                    ...
                    if(NI_number == '') {
                        ...
                        $('#gov_number_required').html('The INN Number for the Russia is set so it must be at least ' + '{{$NI_min_number}}' + ' characters long.');
                        error_detect = 1;
                    } else {
