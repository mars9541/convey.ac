    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li><a href="{{url('advisors/search')}}" class="waves-effect {{Auth::user()->advisors_type == 'advisor' ? "" : "d-none"}}"><i class="mdi mdi-magnify"></i><span> Search </span></a></li>
                <li><a href="{{url('advisors/search-credits')}}" class="waves-effect {{Auth::user()->advisors_type == 'advisor' ? "" : "d-none"}}"><i class="mdi mdi-account-search"></i><span> Search Credits </span></a></li>
