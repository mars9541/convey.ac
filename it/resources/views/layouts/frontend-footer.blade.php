        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            <li><a href="{{url('/press')}}">Stampa</a></li>
                            <li><a href="{{url('/brand')}}">Brand Guide</a></li>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="{{asset('landing_front')}}/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Regno Unito">
                                    <span>Regno Unito</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="{{asset('landing_front')}}/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Stati Uniti">
                            ...
                            <li class="float-none">
                                <a onclick="onCountrySite('ie')">
                                    <img src="{{asset('landing_front')}}/images/country/ireland.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Irlanda">
                                    <span>Irlanda</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('au')">
                                    <img src="{{asset('landing_front')}}/images/country/australia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Australia">
                                    <span>Australia</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="{{asset('landing_front')}}/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Spagna">
                                    <span>Spagna</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="{{asset('landing_front')}}/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Germania">
                                    <span>Germania</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('fr')">
                                    <img src="{{asset('landing_front')}}/images/country/france.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Francia">
                                    <span>Francia</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="{{asset('landing_front')}}/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Italia">
                                    <span>Italia</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="{{asset('landing_front')}}/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Giappone">
                                    <span>Giappone</span>
                                </a>
                            </li>
                            {{--<li class="float-none">
                                <a onclick="onCountrySite('ru')">
                                    <img src="{{asset('landing_front')}}/images/country/russia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Russia">
                                    <span>Russia</span>
                                </a>
                            </li>--}}
                        </ul>
