            ...
            <div class="loginPage loginForm">
                ...
                <div class="loginDetail">
                    <div class="loginDetail-inner" style="max-width: 440px;">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="Inserisci il tuo indirizzo email" required value="{{old('email')}}">
                        ...
                        <input type="text" name="captcha_code" size="28" maxlength="6" required placeholder="Risolvi e inserisci la somma sopra" style="padding-inline:5px;" autocomplete="off"/>
                        <a href="#" onclick="document.getElementById('captcha').src = '{{url('vendor')}}/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">Cambia immagine</a>
                    </div>
                </div>
                <div class="loginBottom" style="width: 440px;">
					<button  class="btn btn-primary submitBtn">ACCEDI</button>
					<a href="{{route('login_retrieval')}}" class="clickhere text-convey-green" >Clicca qui per recuperare i tuoi dati</a>
                </div>
                </form>
            </div>
        </div>
