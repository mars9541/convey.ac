    ...
    <div class="about-business-2x">
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    @foreach($gallery_list as $gallery_info)
                        <div class="col-md-4 pr-3 pl-0 pb-3 pt-0" onclick="javascript:onDetailPage('{{$gallery_info->id}}')">
                            <div class="border" style="border-color: #bebfc1!important;">
                                ...
                                <h5 class="mt-3 header-title gallery_title">{{$gallery_info->gallery_title}}</h5>
                                <div class="about-business-right-2x gallery_text p-2" style="font-size: 14px; line-height: 1.5;">
                                    {!! $gallery_info->gallery_text !!}
                                </div>
                                {{--                            <p class="text-muted mt-3 gallery_text" style="font-size: 14px; line-height: 1.5">{{$gallery_info->gallery_text}}</p>--}}
                                <div class="col-sm-6 offset-sm-6 text-right mb-3 mt-3">
                                    <a href="javascript:onDetailPage('{{$gallery_info->id}}')" class="card-link text-right color-black-light">
