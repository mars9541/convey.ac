                ...
                <div class="tab-pane active p-3" id="faq" role="tabpanel">
                    <div class="table-rep-plugin">
                        ...
                        <div id="accordion">
                            ...
                            <div class="card">
                                <div class="card-header bg-white border-bottom-0 p-3" id="heading{{$key}}">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control select2" name="department_id" required>
                                        ...
                                        @foreach($department as $item)
                                            <?php $index++?>
                                            <option value="{{$item->id}}" <?php if($index == 1) echo "selected" ?>>{{$item->department_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
