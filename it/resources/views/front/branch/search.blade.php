                            ...
                            <div class="col-6">
                                <div class="row text-center p-4">
                                    ...
                                    <div class="col-12 mt-3">
                                        <span class="font-18">Please ask your account administrator to acquire more.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 p-4">
        ...
        @section('script')
            <script>
                ...
                function request_record_unlock() {
                    ...
                    $.ajax({
                        url: "{{ route('branch.request_record_unlock') }}",
                        method: "POST",
                ...
                $('#search_btn').on('click',function(){
                    ...
                    $.ajax({
                        url:"{{route('branch.record_search')}}",
                        type: "POST",
                        data: {
                ...
                $('#sent_request_table').DataTable({
                    ...
                    searching: false,
                    ajax:{
                        url: "{{ route('branch.get_sent_request_history_list') }}",
                        method: 'post',
                    },
                    columns:
                        [
                ...
                function onSaveRating(cbr_id) {
                    ...
                    $.ajax({
                        url:"{{ route('branch.save_rate_record') }}",
                        method:"POST",
                        data: {
                            'cbr_id': cbr_id,
                ...
                function on_sent_request_click() {
                    ...
                    if(NI_number == '') {
                        ...
                        $('#gov_number_required').html('The Codice fiscale for the Italy is set so it must be at least ' + '{{$NI_min_number}}' + ' characters long.');
                        error_detect = 1;
                    } else {
                    ...
                    $.ajax({
                        url:"{{ route('branch.sent_request_add') }}",
                        method:"POST",
                        data: {
                ...
                {
                    $.ajax({
                        url:"{{route('branch.get_record_version')}}",
                        type: "POST",
                        data: {
                            id:id,
                        },
