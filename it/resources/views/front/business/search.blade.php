            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                                ...
                                <div class="row text-center p-4">
                                    ...
                                    <div class="col-12 text-white mt-2">
                                        <button class="btn bg-convey-green text-white">
                                            <a href="{{url('business/search-credits?tab=2')}}" class="text-white font-22">Click Here</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- <h5 class="color-black-light">You don’t have any credits to complete this search ….to purchase more credits please click <a href="{{url('business/search-credits?tab=2')}}" class="text-convey-green">here</a></h5> -->
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn bg-convey-green text-white" data-dismiss="modal">Close</button>
                    </div>
        ...
        @section('script')
            <script>
                ...
                function request_record_unlock() {
                    ...
                    $.ajax({
                        url: "{{ route('business.request_record_unlock') }}",
                        method: "POST",
                ...
                $('#search_btn').on('click',function() {
                    ...
                    $.ajax({
                        url:"{{route('business.record_search')}}",
                        type: "POST",
                        data: {
                ...
                $('#sent_request_table').DataTable({
                    ...
                    searching: false,
                    ajax:{
                        url: "{{ route('business.get_sent_request_history_list') }}",
                        method: 'post',
                    },
                    columns:
                        [
                ...
                function on_sent_request_click() {
                    ...
                    $.ajax({
                        url:"{{ route('business.sent_request_add') }}",
                        method:"POST",
                        data: {
                ...
                {
                    $.ajax({
                        url:"{{route('business.get_record_version')}}",
                        type: "POST",
                        data: {
                            id:id,
                        },
