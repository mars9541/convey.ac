...
class SettingsController extends Controller
{
    ...
    public function account_details_update(Request $request)
    {
        ...
        return response()->json(['success' => 'cf is successfully saved', 'ni_flag' => $ni_flag]);
    }
    ...
    function random_strings()
    {
        ...
        $return_strings = substr(str_shuffle($str_letters), 0, 8).substr(str_shuffle($str_numbers), 0, 8);
    ...
    public function auto_save_ni_number(Request $request)
    {
        ...
        return response()->json(['success' => 'NI number is successfully saved', 'ni_flag' => $ni_flag]);
    }
