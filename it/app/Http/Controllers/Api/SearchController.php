...
class SearchController extends Controller
{
    ...
    {
        if($request->National_Number != 'ABC123456789ABC1') {
        ...
        $messages = array(
            'National_Number.min' => 'The Codice fiscale for the Italy is set so it must be at least '.$min_num.' characters long.',
        );
                ...
                if(count($max_version) > 0) {
                    foreach ($max_version as $key => $child) {
                        ...
                        if($request->National_Number != 'ABC123456789ABC1') {
                            ...
                            $child_record_pattern_array->Record_creators_CBR_id = "IT000000";
...
//                    array_push($item_child, $child_record_pattern_array);
                ...
                if($request->National_Number != 'ABC123456789ABC1') {
                    ...
                    $record_pattern_array->Record_creators_CBR_id = "IT000000";
...
//                date_modify($today, "-10 minutes");
    ...
    public function request_record_unlock(Request $request)
    {
        ...
        if($request->National_Number == 'ABC123456789ABC1') {
            return response()->json(['errors' => ['This test number is internally controlled and cannot be added to ABC123456789ABC1']]);
        }
