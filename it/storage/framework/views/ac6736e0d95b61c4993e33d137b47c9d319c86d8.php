          ...
          <div id="form_overlay">
            ...
            <div class="loginDetail">
                ...
                <div class="loginDetail-inner " id="step_1">
                    <h2><?php echo e(__('ISCRIVITI ORA')); ?> <span>(FASE 1 DI 4)</span></h2>
                    ...
                    <select class="form-control" required name="user_type" id="user_type">
                        ...
                        <option value="advisors"> Per consulenti/sviluppatori/collaboratori/redattori</option>
                    ...
                    <div class="col-md-12 test-font-16 hidden" id="advisors_radio">
                        ...
                        <div>
                            ...
                            <label for="bb"> Forniamo consulenza aziendale</label>
                        </div>
                        <div>
                            <input type="radio" name="advisors_type"  id="cc" value="writer">
                            <label for="cc"> Scriviamo articoli aziendali</label>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/it/resources/views/auth/register.blade.php ENDPATH**/ ?>