        ...
        <?php $__env->startSection('script'); ?>
            <script>
                ...
                function request_record_unlock() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('business.request_record_unlock')); ?>",
                        method: "POST",
                ...
                $('#sent_request_table').DataTable({
                    ...
                    searching: false,
                    ajax:{
                        url: "<?php echo e(route('business.get_sent_request_history_list')); ?>",
                        method: 'post',
                    },
                    columns:
                        [
                ...
                function on_sent_request_click() {
                    ...
                    $.ajax({
                        url:"<?php echo e(route('business.sent_request_add')); ?>",
                        method:"POST",
                        data: {
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/it/resources/views/front/business/search.blade.php ENDPATH**/ ?>