                    ...
                    <div class="tab-pane p-3" id="record_settings" role="tabpanel">
                        <div class="table-rep-plugin">
                            ...
                            <form  id="record_settings_from">
                                <div class="table-responsive mb-0" data-pattern="priority-columns">
                                    <div class="col-md-12 m-t-40 display-inline">
                                        <label class="col-form-label col-md-3 text-right color-black-light" for="ni">cf: </label>
                                        <div class="col-md-8 display-inline">
    ...
    <script>
        ...
        $('#ni').on('input',function(e) {
            ...
            if(NI_number.search(' ') > 0) {
                ...
                $('input[name=NI_identity_number]').css('margin-bottom', '0px');
                $('#space_error').addClass('filled');
                $('#space_error li').html('The Codice fiscale for the Italy is set so it must be at least ' + NI_min_number + ' characters long.');
            } else if(NI_number == 'ABC123456789ABC1') {
                $('input[name=NI_identity_number]').css('box-shadow', '0px 0px 4px red');
                $('input[name=NI_identity_number]').css('margin-bottom', '0px');
                $('#space_error').addClass('filled');
...
<?php echo $__env->make('layouts.master-citizen', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/it/resources/views/front/citizen/settings.blade.php ENDPATH**/ ?>