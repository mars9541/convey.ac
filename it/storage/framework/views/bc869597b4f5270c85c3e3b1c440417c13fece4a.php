                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light btco-hover-menu">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto business-nav left-nav hidden-lg hidden-md hidden-sm hidden-xs" style="margin-right: 20px;">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/')); ?>">Panoramica</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/benefits')); ?>">Benefici</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/price')); ?>">Prezzo</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/secure')); ?>">Sicuro</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/upgrade')); ?>">Passa a CONVEY</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/more')); ?>">ALTRO</a>
                                </li>
                            </ul>
                            ...
                            <ul class="navbar-nav ml-auto right-nav business-nav">
                                ...
                                <li class="nav-item hidden-md hidden-sm hidden-xs">
                                    <a class="nav-link d-inline-flex align-items-center" href="javascript:void(0)" >
                                        ...
                                        <img id="img_country" src="<?php echo e(asset('landing_front')); ?>/images/country/italy.png" style="width: 20px; height: 20px;" alt="Italy">
                                    ...
                                    <ul class="cntry">
                                        ...
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('england', 'gb')" style="padding-right: 0px!important;">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/england.png" width="30px" alt="Regno Unito">
                                                <span class="cnt-spn">Regno Unito</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('usa', 'us')">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/usa.png" width="30px" alt="Stati Uniti">
                                                <span class="cnt-spn">Stati Uniti</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('ireland', 'ie')">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/ireland.png" width="30px" alt="Irlanda">
                                        ...
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('france', 'fr')">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/france.png" width="30px" alt="Francia">
                                                <span class="cnt-spn">Francia</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('germany', 'de')">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/germany.png" width="30px" alt="Germania">
                                                <span class="cnt-spn">Germania</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('spain', 'es')">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/spain.png" width="30px" alt="Spagna">
                                        ...
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('italy', 'it')">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/italy.png" width="30px" alt="Italia">
                                                <span class="cnt-spn">Italia</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="country-class" onclick="onSelectCountry('japan', 'jp')">
                                                <img src="<?php echo e(asset('landing_front')); ?>/images/country/japan.png" width="30px" alt="Giappone">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="a_signup" href="<?php echo e(route('register')); ?>"><span class="highlight px-3">PASSA A CONVEY ORA</span></a>
                                </li>
...
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/it/resources/views/layouts/frontend-topbar.blade.php ENDPATH**/ ?>