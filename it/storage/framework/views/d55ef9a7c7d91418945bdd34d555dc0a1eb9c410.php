                                ...
                                <form id="update_account">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-9 display-inline">
                                            <select class="custom-select" name="business_type" disabled>
                                                <option
                                                    value="company" <?php echo e(Auth::user()->business_type == 'company' ? 'selected' : ''); ?>>
                                                    Company
                                                </option>
                                                <option
                                                    value="organisation" <?php echo e(Auth::user()->business_type == 'organisation' ? 'selected' : ''); ?>>
                                                    Organisation
                                                </option>
                                                <option
                                                    value="selfemployed" <?php echo e(Auth::user()->business_type == 'selfemployed' ? 'selected' : ''); ?>>
                                                    Self Employed
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-9 display-inline">
                                            <input type="text" class="form-control" name="website" id="website"
                                                   value="<?php echo e($user_info->website); ?>"/>
                                        ...
                                        <div class="col-md-9 display-inline">
                                            <select class="custom-select" name="market">
                                                <?php $__currentLoopData = $market; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($item->name); ?>" <?php echo e($user_info->market==$item->name?'selected':''); ?>><?php echo e($item->name); ?></option>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-9 display-inline">
                                            <select class="custom-select" name="employees">
                                                <option
                                                    value="1-9" <?php echo e($user_info->employees == '1-9' ? 'selected' : ''); ?>>1-9
                                                </option>
                                                <option
                                                    value="10-99" <?php echo e($user_info->employees == '10-99' ? 'selected' : ''); ?>>
                                                    10-99
                                                </option>
                                                <option
                                                    value="100-250" <?php echo e($user_info->employees == '100-250' ? 'selected' : ''); ?>>
                                                    100-250
                                                </option>
                                                <option
                                                    value="251+" <?php echo e($user_info->employees == '251+' ? 'selected' : ''); ?>>
                                                    251+
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-3 display-inline">
                                            <input type="checkbox" name="direct_connect" <?php echo e($user_info->direct_connect_flag != 0 ? "checked" : ""); ?> class="rem_me" id="direct_connect_type">
                                            <label for="direct_connect_type" class="col-form-label color-black-light">
                                                DIRECT CONNECT
                                            </label>
                                        </div>
                                        <div class="col-md-3 display-inline">
                                            <input type="checkbox" name="hris_connect" <?php echo e($user_info->hris_connect_flag != 0 ? "checked" : ""); ?> class="rem_me" id="hris_connect_type">
                                            <label for="hris_connect_type" class="col-form-label color-black-light">
                                                HRIS CONNECT
                                            </label>
                                        </div>
                                        <div class="col-md-3 display-inline">
                                            <input type="checkbox" name="api_connect" <?php echo e($user_info->api_connect_flag != 0 ? "checked" : ""); ?> class="rem_me" id="api_connect_type">
                                ...
                                <form method="post" id="sample_form" class="form-horizontal"
                                        ...
                                        <div class="col-md-12 m-t-30  display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="ocb_name"
                                                       value="<?php echo e($user_info->ocb_name); ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            <label class="col-form-label col-md-4 text-right color-black-light">Organisation
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="company_ma_HBN"
                                                       value="<?php echo e($user_info->company_ma_HBN); ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            <label class="col-form-label col-md-4 text-right color-black-light">Organisation
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="company_ma_street"
                                                       value="<?php echo e($user_info->company_ma_street); ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            <label class="col-form-label col-md-4 text-right color-black-light">Organisation
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="company_ma_town_or_city"
                                                       value="<?php echo e($user_info->company_ma_town_or_city); ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            <label class="col-form-label col-md-4 text-right color-black-light">Organisation
                                                ...
                                                <select class="form-control" name="company_lrd_country_show" required
                                                    ...
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                                <?php if( $key == "IT" ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="company_ma_postcode"
                                                       value="<?php echo e($user_info->company_ma_postcode); ?>"/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="VAT_if_registered"
                                                       value="<?php echo e($user_info->VAT_if_registered); ?>"/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="lrd_firstname"
                                                       value="<?php echo e($user_info->lrd_firstname); ?>" required/>
                                            </div>
                                        ...
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="lrd_lastname"
                                                       value="<?php echo e($user_info->lrd_lastname); ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            <label class="col-form-label col-md-4 text-right color-black-light">Legal
                                            ...
                                            <div class="col-md-7  display-inline">
                                                <div class="input-group ">
                                                    <input type="date" max="9999-12-31" class="form-control display-inline"
                                                           ...
                                                           name="lrd_DOB" value="<?php echo e($user_info->lrd_DOB); ?>" required>
                                        ...
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <select class="form-control" name="lrd_country" required>
                                                    ...
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                                <?php if( $user_info->lrd_country == $key ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <select class="form-control" name="lrd_nationality" required>
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                                <?php if( $user_info->lrd_nationality == $key ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="ma_HBN"
                                                       value="<?php echo e($user_info->ma_HBN); ?>" required/>
                                            </div>
                                        ...
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="ma_street"
                                                       value="<?php echo e($user_info->ma_street); ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="ma_town_or_city"
                                                       value="<?php echo e($user_info->ma_town_or_city); ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="ma_postcode"
                                                       value="<?php echo e($user_info->ma_postcode); ?>"/>
                                            </div>
                                        ...
                                        <div class="col-md-12 m-t-30  display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="company_no"
                                                       value="<?php echo e($user_info->company_no); ?>" required/>
                                    ...
                                    <?php elseif($user_info->business_type=='selfemployed'): ?>
                                        ...
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="ma_postcode"
                                                       value="<?php echo e($user_info->ma_postcode); ?>" required/>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    <div class="col-md-12 m-t-30">
                            ...
                            <form id="upload_logo_form">
                                <div class="col-md-12 m-t-30 display-inline">
                                    ...
                                    <div class="col-md-6 display-inline" style="vertical-align: top">
                                        <?php if(!is_null($logo_url)): ?>
                                            <img src="<?php echo e(url('public/upload')); ?>/<?php echo e($logo_url); ?>" id="record_logo_image"
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function upload_logo() {
            ...
            $.ajax({
                url: "<?php echo e(route('business.logo_add')); ?>",
                method: "POST",
                data: formData,
                contentType: false,
                cache: false,
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        $('#record_logo_image').attr('src', "<?php echo e(url('public/upload/')); ?>" + "/" + data.logo_url);
                    }
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/it/resources/views/front/business/settings.blade.php ENDPATH**/ ?>