    ...
    <div class="bussiness-contact-form">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" id="user_name" placeholder="Il tuo nome">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" class="form-control" id="user_email" placeholder="La tua email">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" class="form-control" id="user_number" placeholder="Numero di telefono">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <textarea class="form-control" id="user_message" rows="3" placeholder="Il tuo messaggio"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mt-1">

                            <img id="captcha" src="<?php echo e(url('vendor')); ?>/securimage/securimage_show.php" alt="CAPTCHA Image" />
                            <input type="text" name="captcha_code" id="captcha_code" size="28" maxlength="6" required placeholder="Risolvere e inserire la somma di cui sopra" style="padding-inline:5px;" autocomplete="off"/>
                            <a href="#" onclick="document.getElementById('captcha').src = '<?php echo e(url('vendor')); ?>/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">cambiare immagine</a>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                ...
                <div class="col-md-6">
                    <h4 style="line-height: 160%;">Il nostro team è umano al 100% (non usiamo bot) e sempre pronto a rispondere alle tue domande</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-sc">
                    ...
                    <p style="text-align: center;">Il nostro staff è disponibile dal lunedì al venerdì dalle 09:00 alle 16:00</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="business-cta-right-2">
                            <a href="<?php echo e(route('register')); ?>" class=" btn bussiness-btn-larg">PASSA A CONVEY ORA</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.status == "Message Sent") {
                        ...
                        alertify.success('Messaggio inviato!');
                    } else {
                        alertify.logPosition("bottom right");
                ...
                error: function () {
                    ...
                    $('#btn_send_message').prop('disabled', false);
                    alertify.logPosition("bottom right");
                    alertify.error('Errore del server!');
                }
            })
        })
    </script>
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/it/resources/views/front/getintouch.blade.php ENDPATH**/ ?>