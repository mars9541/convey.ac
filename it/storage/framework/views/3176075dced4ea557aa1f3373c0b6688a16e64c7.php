...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Create Records using API Connect</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="card m-b-20 text-center">
            <div class="card-body" style="padding: 13px;">
                <p class="m-0 color-black-light">Establish an API connection to the CONVEY Databank and integrate your existing systems.</p>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" style="max-width:900px!important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 m-t-5">
                    <label class="col-form-label col-md-3 text-right color-black-light display-inline">Security Number: </label>
                    <div class="col-md-8 display-inline">
                        <input type="text" class="form-control" id="security_number" readonly />
                    </div>
                </div>
                <div class="col-md-12 m-t-5">
...
<script>
    ...
    $('#record_history_table').DataTable({
        ...
        autoWidth: false,
        ajax:{
            url: "<?php echo e(route('business.get_api_record_list')); ?>",
            method:'post',
            data:{
    ...
    $('#record_errors_table').DataTable({
        ...
        autoWidth: false,
        ajax:{
            url: "<?php echo e(route('business.get_api_record_error_list')); ?>",
            method:'post',
            data:{
                _token: $('meta[name="_token"]').attr('content')
            }
        ...
        columns:[
            ...
            },
            {
                ...
                class: 'text-center p-2',
                render: function (data, type, row) {
                    return '<a href="javascript:delete_record(\''+data+'\')" class="text-dark" title="Remove"><button type="button" class="btn btn-danger waves-effect waves-light">Remove</button></a> ';
                }
            },
            {
                name: 'View',
    ...
    {
        $.ajax({
            url:"<?php echo e(url('business/get_api_record_info')); ?>/"+id,
            dataType:"json",
            success:function(html){
                ...
                $('#security_number').val(html.data.security_number);
    ...
    {
        $.ajax({
            url:"<?php echo e(url('business/del_api_record')); ?>/"+id,
            dataType:"json",
            success:function(html){
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/it/resources/views/front/business/api-connect.blade.php ENDPATH**/ ?>