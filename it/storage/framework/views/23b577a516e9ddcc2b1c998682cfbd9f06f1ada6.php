                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form id="update_account">
                                <div class="col-md-12 m-t-30">
                                    <label class="col-form-label col-md-2 text-right color-black-light display-inline">HRIS ID: </label>
                                ...
                                <div class="col-md-12 m-t-30 display-inline text-center">
                                    ...
                                    <input type="radio" name="hris_type" value="software" id="a" <?php echo e($user_info->hris_type=='software'?'checked':''); ?>>
                                    <label class="col-form-label col-md-2 text-left color-black-light" for="a">HRIS software only </label>

                                    <input type="radio" name="hris_type" value="tracking" id="b" <?php echo e($user_info->hris_type=='tracking'?'checked':''); ?>>
                                    <label class="col-form-label col-md-3 text-left color-black-light" for="b">ATS or VMS Software Only</label>

                                    <input type="radio" name="hris_type" value="both" id="c" <?php echo e($user_info->hris_type=='both'?'checked':''); ?>>
                                    <label class="col-form-label col-md-2 text-left color-black-light" for="c">A Combination </label>
                                </div>
                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <?php if($user_info->business_type=='organisation'): ?>
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="IT" name="company_lrd_country">
                                            ...
                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                ...
                                                <option value="<?php echo e($key); ?>" <?php if( $key == "IT" ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Indirizzo postale - House/Building Number:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Indirizzo postale - Street/Road:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_street" value="<?php echo e($user_info->ma_street); ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Indirizzo postale - Town/City:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_town_or_city" value="<?php echo e($user_info->ma_town_or_city); ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Indirizzo postale - Postcode:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-30  display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            ...
                                            <small style="display: none;" id="company_no_error" class="text-danger">
                                                Must be 11 digits Italy company number at least.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                ...
                                <?php elseif($user_info->business_type=='selfemployed'): ?>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="IT" name="lrd_country_show">

                                            <select class="form-control" name="lrd_country" required disabled>
                    ...
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form id="form_list_service">
                                ...
                                <div class="col-md-12 m-t-10 display-inline">
                                    <div class="border pt-3 pb-1">
                                        ...
                                        <label class="col-form-label offset-2 text-right color-black-light pl-3">(Consider using a custom landing page)</label>
                                    </div>
                                </div>

                                <div class="col-md-12 m-t-5 display-inline">
                                    <div class="border pt-3 pb-1">
                                        <label class="col-form-label col-md-2 text-right color-black-light" for="hris_guide">User Guide Upload:</label>
                                        <div class="col-md-2 display-inline">
                                            <input type="file" class="filestyle" data-input="false" data-buttonname="btn-secondary" name="hris_guide" id="hris_guide" accept="application/pdf">
                                        </div>
                                        <?php if(!is_null($user_info->hris_guide)): ?>
                                            <a href="<?php echo e(url('public/upload')); ?>/<?php echo e($user_info->hris_guide); ?>" id="a_hris_guide" class="display-inline" target="_blank"><img src="<?php echo e(asset('assets/images/pdf.png')); ?>" width="50px"></a>
                                        <?php else: ?>
                                            <a href="" id="a_hris_guide" class="display-inline" target="_blank"></a>
                                        <?php endif; ?>
                                        <div class="offset-2 col-md-10 display-inline">
                                            <ul class="parsley-errors-list float-left" id="guide_required">
                                                <li class="parsley-required">This value is required.</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-12 display-inline">
                                            <label class="col-form-label offset-2 text-right color-black-light pl-1">This step by step guide will be shown to users so they know how to access the convey DATABANK using your systems.</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 m-t-5 display-inline">
                                    <div class="border pt-3 pb-1">
                                        <label class="col-form-label col-md-2 text-right color-black-light" for="#">High Resolution Image of Logo:</label>
                                        <div class="col-md-2 display-inline">
                                            <input type="file" class="filestyle" id="imgInp" data-input="false" data-buttonname="btn-secondary" name="logo" accept="image/*">
                                        </div>
                                        <?php if(!is_null($user_info->Logo)): ?>
                                            <img src="<?php echo e(url('public/upload')); ?>/<?php echo e($user_info->Logo); ?>" id="logo_image" alt="your image" width="100px">
                                        <?php else: ?>
                                            <img src="" id="logo_image" width="100px" style="display: none;">
                                        <?php endif; ?>
                                        <div class="offset-2 col-md-10 display-inline">
                                            <ul class="parsley-errors-list float-left" id="logo_required">
                                                <li class="parsley-required">This value is required.</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 m-t-5 display-inline">
                                    <div class="border pt-3 pb-1">
                                        <label class="col-form-label col-md-2 text-right color-black-light" for="tech_email">Technical Email:</label>
                                        <div class="col-md-9 display-inline">
                                            <input type="email" class="form-control" name="tech_email" id="tech_email" value="<?php echo e($user_info->tech_email); ?>" />
                                        </div>
                                        <div class="offset-2 col-md-10 display-inline">
                                            <ul class="parsley-errors-list float-left" id="tech_required">
                                                <li class="parsley-required">This value is required.</li>
                                            </ul>
                                            <ul class="parsley-errors-list float-left" id="tech_invalid">
                                                <li class="parsley-required">Invalid email.</li>
                                            </ul>
                                        </div>


                                        <label class="col-form-label col-md-2 text-right color-black-light" for="pr_email">PR Email:</label>
                                        <div class="col-md-9 display-inline">
                                            <input type="email" class="form-control" name="pr_email" id="pr_email" value="<?php echo e($user_info->pr_email); ?>" />
                                        </div>
                                        <div class="offset-2 col-md-10 display-inline">
                                            <ul class="parsley-errors-list float-left" id="pr_required">
                                                <li class="parsley-required">This value is required.</li>
                                            </ul>
                                            <ul class="parsley-errors-list float-left" id="pr_invalid">
                                                <li class="parsley-required">Invalid email.</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-10 m-t-15 display-inline text-center">
...
<script>
    ...
    function readPDFURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                $('#a_hris_guide').attr('href', e.target.result);
                $('#guide_required').removeClass('filled');
            }
    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                $('#logo_required').removeClass('filled');
            }
    ...
    $(document).on('input','input[name=tech_email]',function(){
        var tech_email = $('input[name=tech_email]').val();

        if($('#tech_email').val() != '') {
            $('#tech_required').removeClass('filled');
        }
    })

    $("#tech_email").blur(function () {
        if ($('#tech_email').val() == '') {
            return false;
        }

        if (/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test($('#tech_email').val())) {
            $('#tech_invalid').removeClass('filled');
        } else {
            $('#tech_invalid').addClass('filled');
        }
    });

    $(document).on('input','input[name=pr_email]',function(){
        var tech_email = $('input[name=pr_email]').val();

        if($('#pr_email').val() != '') {
            $('#pr_required').removeClass('filled');
        }
    })
    ...
    $("#pr_email").blur(function () {
        ...
        if (/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test($('#pr_email').val())) {
            $('#pr_invalid').removeClass('filled');
        } else {
            $('#pr_invalid').addClass('filled');
        }
    });
    ...
    function update_list_service(update_flag = null) {
        var website_url = $('input[name=website]').val();
        var url_array = website_url.split(' ');
        var error_detect = 0;
        ...
        if($('#a_hris_guide').attr('href') == '') {
            $('#guide_required').addClass('filled');
            error_detect = 1;
        } else {
            $('#guide_required').removeClass('filled');
        }
        ...
        $.ajax({
            url: "<?php echo e(route('settings.update_hris_list_service')); ?>",
            method: "POST",
            data: form_data,
            contentType: false,
            cache: false,
    ...
    $('#list_service').on('click', function(event) {
        ...
        if($('#list_service').text().indexOf('List Service') >= 0) {
            update_list_service('hris_list_service');
        }
    })
    ...
    function view_guide_detail(input){
        $.ajax({
            url:"<?php echo e(route('hris.get_guide_temp')); ?>",
            method:"POST",
            data: {
                item:input,
            },
...
<?php echo $__env->make('layouts.master-hris', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/it/resources/views/front/hris/settings.blade.php ENDPATH**/ ?>