        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5 class="color-black-light">You don’t have any credits to complete this search ….to purchase more credits please click <a href="<?php echo e(url('advisors/search-credits?tab=2')); ?>" class="text-convey-green">here</a></h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn bg-convey-green text-white" data-dismiss="modal">Close</button>
                </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function request_record_unlock() {
            ...
            $.ajax({
                url: "<?php echo e(route('advisors.request_record_unlock')); ?>",
                method: "POST",
        ...
        $('#search_btn').on('click',function(){
            ...
            $.ajax({
                url:"<?php echo e(route('advisors.record_search')); ?>",
                type: "POST",
                data: {
        ...
        {
            $.ajax({
                url: "<?php echo e(route('advisors.get_qa_type_info')); ?>",
                method: "POST",
                data:
                    {
                        parent_id: id
        ...
        function on_sent_request_click() {
            ...
            $.ajax({
                url:"<?php echo e(route('advisors.sent_request_add')); ?>",
                method:"POST",
                data: {
        ...
        function onSaveRating(cbr_id) {
            ...
            $.ajax({
                url:"<?php echo e(route('settings.save_rate_record')); ?>",
                method:"POST",
                data: {
                    'cbr_id': cbr_id,
        ...
        $('#sent_request_table').DataTable({
            ...
            searching: false,
            ajax:{
                url: "<?php echo e(route('advisors.get_sent_request_history_list')); ?>",
                method: 'post',
            },
            columns:
                [
        ...
        {
            $.ajax({
                url:"<?php echo e(route('advisors.get_record_version')); ?>",
                type: "POST",
                data: {
                    id:id,
                },
...
<?php echo $__env->make('layouts.master-advisors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/it/resources/views/front/advisors/search.blade.php ENDPATH**/ ?>