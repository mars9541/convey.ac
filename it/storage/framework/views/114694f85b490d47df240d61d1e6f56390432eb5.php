        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            <li><a href="<?php echo e(url('/brand')); ?>">Guida al marchio</a></li>
                            <li><a href="<?php echo e(url('/getintouch')); ?>"> Contatto</a></li>
                            <li><a href="javascript:onOpenModal('cookies')"> Cookies</a></li>
                            <li><a href="javascript:onOpenModal('privacy')"> Informativa sulla privacy</a></li>
                            <li><a href="javascript:onOpenModal('legal')"> Note legali</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Regno Unito">
                                    <span>Regno Unito</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Stati Uniti">
                            ...
                            <li class="float-none">
                                <a onclick="onCountrySite('ie')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/ireland.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Irlanda">
                                    <span>Irlanda</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('au')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/australia.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Australia">
                                    <span>Australia</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Spagna">
                                    <span>Spagna</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Germania">
                                    <span>Germania</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('fr')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/france.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Francia">
                                    <span>Francia</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Italia">
                                    <span>Italia</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Giappone">
                                    <span>Giappone</span>
                                </a>
                            </li>
...
<div class="modal fade bs-example-modal-lg" id="privacy_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">Politica sulla privacy</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 1.75rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 1rem!important;">Nome dell'azienda: CONVEY Databank Ltd <br>
                        Indirizzo dell'azienda:  85 Great Portland Street, primo piano, Londra, W1W7LT
                    </p>
                    <p style="margin-bottom: 1rem!important;">
                        A CONVEY abbiamo a cuore la vostra privacy.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Questo è il motivo per cui raccogliamo i vostri dati personali solo se abbiamo una buona ragione per farlo ed è anche il motivo per cui vogliamo comunicare in modo trasparente ciò che facciamo con i vostri dati personali, la politica sulla privacy differisce leggermente a seconda di come si utilizza CONVEY, per esempio un individuo che utilizza CONVEY per trovare i record su se stessi avrà una politica leggermente diversa da una società che utilizza CONVEY per creare record.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        I termini di utilizzo completi e pertinenti sono disponibili per visualizzare durante il processo di creazione dell'account.
                    </p>
...
<div class="modal fade bs-example-modal-lg" id="legal_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">Note legali</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 2rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 0.7rem!important;">Nome dell'azienda: CONVEY Databank Ltd </p>
                    <p style="margin-bottom: 0.7rem!important;">Indirizzo dell'azienda:  85 Great Portland Street, primo piano, Londra, W1W7LT </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Il sito CONVEY.ac , accessibile attraverso il seguente URL: https://www.convey.ac, è di proprietà di CONVEY Databank Ltd, una società a responsabilità limitata registrata nel Regno Unito, con sede legale situata a 85 Great Portland Street, First Floor, Londra, W1W7LT
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Il sito è stato sviluppato e viene mantenuto da CONVEY Databank Ltd, con hosting geografico nel Regno Unito, UE e USA.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Le condizioni d'uso complete sono disponibili per la visualizzazione durante il processo di creazione dell'account.
                    </p>
                    <p style="line-height: 25px!important;">
                        Per supporto/reclami: Si prega di utilizzare il modulo di contatto sul sito.
                    </p>
                </div>
...
<?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/it/resources/views/layouts/frontend-footer.blade.php ENDPATH**/ ?>