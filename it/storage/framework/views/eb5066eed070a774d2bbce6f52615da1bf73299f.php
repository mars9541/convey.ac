                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label class="col-form-label col-md-12 text-center color-black-light display-inline font-20">
                                                What is the Applicants Codice fiscale<br> (or replacement search number):
                                            </label>
                                        </div>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control col-sm-3  mx-auto" placeholder="Enter Insurance Number:" id="NI_search_number" value="ABC123456789ABC1">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h5 class="color-black-light">You don’t have enough credits to complete this search, please ask your account administrator to acquire more</h5>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn bg-convey-green text-white" data-dismiss="modal">Close</button>
                    </div>
        ...
        <?php $__env->startSection('script'); ?>
            <script>
                ...
                function request_record_unlock() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('branch.request_record_unlock')); ?>",
                        method: "POST",
                ...
                $('#search_btn').on('click',function(){
                    ...
                    $.ajax({
                        url:"<?php echo e(route('branch.record_search')); ?>",
                        type: "POST",
                        data: {
                                    ...
                                    res.data.forEach(function(item,key) {
                                        ...
                                        if(item.ids&&item.ids.length>0){
                                            for (var i = 0; i < item.ids.length; i++) {
                                                if(i == 0) {
                                                    version += 'View Previous Versions... <a class="text-convey-green" ' +
                                                        'href="javascript:version_view(\'' + item.ids[item.ids.length - i - 1] + '\')" ' +
                                                        'style="margin-right:10px;">' + (i + 1) + '</a>';
                                                } else {
                                        ...
                                        var creat_date = item.record_date;

                                        if($('#NI_search_number').val() == 'ABC123456789ABC1') {
                                            item.ocb_name = 'Mars Partners Ltd';
                                            item.CBR_id = "IT000000";
                ...
                $('#sent_request_table').DataTable({
                    ...
                    searching: false,
                    ajax:{
                        url: "<?php echo e(route('branch.get_sent_request_history_list')); ?>",
                        method: 'post',
                    },
                    columns:
                        [
                ...
                function onSaveRating(cbr_id) {
                    ...
                    $.ajax({
                        url:"<?php echo e(route('branch.save_rate_record')); ?>",
                        method:"POST",
                        data: {
                            'cbr_id': cbr_id,
                ...
                function on_sent_request_click() {
                    ...
                    if(NI_number == '') {
                        ...
                        $('#gov_number_required').html('The Codice fiscale for the Italy is set so it must be at least ' + '<?php echo e($NI_min_number); ?>' + ' characters long.');
                        error_detect = 1;
                    } else {
                    ...
                    $.ajax({
                        url:"<?php echo e(route('branch.sent_request_add')); ?>",
                        method:"POST",
                        data: {
                ...
                {
                    $.ajax({
                        url:"<?php echo e(route('branch.get_record_version')); ?>",
                        type: "POST",
                        data: {
                            id:id,
                        },
...
<?php echo $__env->make('layouts.master-business-branch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/it/resources/views/front/branch/search.blade.php ENDPATH**/ ?>