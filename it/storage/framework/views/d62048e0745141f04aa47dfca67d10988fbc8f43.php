...
<div class="row">
	<div class="card-body" style="background-color:white;">
	    ...
	    <div class="col-md-12 m-t-10 invoice-title">
	        <div class="row" style="padding-bottom: 0px;">
	            <div style="padding:0px 5px;">
	                <p class="title-info inline" >Invoice No.  <?php echo e($spec_info->country_ID); ?>/<?php echo e($data->invoice_number); ?></p>
	    ...
	    <table id="payment_receipt_invoice_to" class="m-t-10">
	        ...
	        <tbody>
	            <tr>
	                <td class="test-font-12"><?php echo e($data->cbr->ocb_name); ?></td>
	            </tr>
	            <tr>
	    ...
	    <table id="payment_receipt_info" class="table m-t-20">
	        ...
	        <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2" class="text-center border-invoice-tax">Subtotal (ex TAX)</td>
                    <td class="text-center border-invoice-tax" ><?php echo e(number_format($data->payment_amount_excluding_vat,2)); ?></td>
                </tr>
                <tr>
                    <td colspan="2" class="border-none"></td>
                    <td colspan="2" class="text-center border-invoice-tax" >Sales Tax </td>
                    <td class="text-center border-invoice-tax" ><?php echo e(number_format($data->vat_amount,2)); ?></td>
                </tr>
                <tr>
                    <td colspan="2" class="border-none"></td>
...
<?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/it/resources/views/front/invoice_pdf.blade.php ENDPATH**/ ?>