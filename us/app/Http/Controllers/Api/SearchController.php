...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $messages = array(
            'National_Number.min' => 'The Social Security Number for the US is set so it must be at least '.$min_num.' characters long.',
        );
                ...
                if(count($max_version) > 0) {
                    foreach ($max_version as $key => $child) {
                        ...
                        if($request->National_Number != 'ABC123456') {
                            ...
                            $child_record_pattern_array->Record_creators_CBR_id = "US000000";
...
//                    array_push($item_child, $child_record_pattern_array);
                ...
                if($request->National_Number != 'ABC123456') {
                    ...
                    $record_pattern_array->Record_creators_CBR_id = "US000000";
