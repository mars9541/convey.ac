            ...
            <div class="loginDetail">
                ...
                <div class="loginDetail-inner hidden" id="step_4">
                    ...
                    <div id="change_detail">
                        ...
                        <input type="text" class="form-control" name="ma_postcode" placeholder="Zip Code" required>
                    </div>
                    <div class="remember">
...
$(document).ready(function(){
    ...
    {
        var countries = '<option value="US">United States</option>' +
        ...
        if($('#business_type').val()=='organisation')
        {
            ...
            $('#change_detail').append('<input type="text" class="form-control" name="ocb_name" placeholder="Organisation Name" required>\n' +
                ...
                '</select>'+
                '        <input type="text" class="form-control" name="company_ma_postcode" placeholder="Organisation Headquarter - Zip Code" required>'+
                ...
                '        <input type="text" class="form-control" name="ma_postcode" placeholder="Mailing Address - Zip Code" required>' +
        ...
        if($('#business_type').val() == 'company')
        {
            ...
            $('#change_detail').append('<input type="text" class="form-control" name="ocb_name" placeholder="Company Name" required>\n' +
                ...
                '   Must be an 8 digit US company number at least.\n'+
                '</small>\n' +
                ...
                '</select>'+
                '        <input type="text" class="form-control" name="company_ma_postcode" placeholder="Company Headquarter - Zip Code" required>'+
                '        <input type="text" class="form-control"name="VAT_if_registered" placeholder="VAT (if available)">\n' +
