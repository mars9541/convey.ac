                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                @if($user_info->business_type=='organisation')
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="GB" name="company_lrd_country">

                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                @foreach ($countries as $key => $country)
                                                <option value="{{ $key }}" @if ( $key == "GB" ) selected @endif>{{ $country }}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Organisation Headquarter - Zip Code:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Mailing Address - Zip Code:</label>
                                        <div class="col-md-7 display-inline">
                                ...
                                @elseif($user_info->business_type=='company')
                                    ...
                                    <div class="col-md-12 m-t-30  display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            ...
                                            <small style="display: none;" id="company_no_error" class="text-danger">
                                                Must be an 8 digit UK company number at least.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Company Headquarter - Zip Code:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="company_ma_postcode" value="{{$user_info->company_ma_postcode}}" />
                                        </div>
                                    </div>
                                ...
                                @elseif($user_info->business_type=='selfemployed')
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="GB" name="lrd_country_show">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Zip Code:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_postcode" value="{{$user_info->ma_postcode}}" />
                                        </div>
                                    </div>
...
<script>
    ...
    $(document).on('input','input[name=company_no]',function(){
        ...
        if (!/^([A-Za-z0-9]{8})$/.test(company_no)) {
