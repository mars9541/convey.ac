                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <div class="col-md-12 display-inline">
                                                ...
                                                @elseif(Auth::user()->activate_branch_manager == "1")
                                                    @if(Auth::user()->activate_branch_direct_connect == "0")
                                                    ...
                                                    @elseif(Auth::user()->activate_branch_direct_connect == "1")
...
@section('script')
    <script>
        ...
        $('#branch_list').DataTable({
            ...
            autoWidth: false,
            ajax:{
                url: "{{ route('business.branch_list') }}",
                method:'post',
                data:{
        ...
        $('#branch_manager').click(function(){
            ...
            $.ajax({
                url: "{{ route('business.activate_branch_manager')}}",
                method: 'post',
                data: {
                    status:value
                },
        ...
        $('#branch_direct_manager').click(function(){
            ...
            $.ajax({
                url: "{{ route('business.activate_branch_direct_manager')}}",
                method: 'post',
                data: {
                    status:value
                },
        ...
        $('#sample_form').on('submit', function(event){
            ...
            {
                $.ajax({
                    url:"{{ route('business.branch_update') }}",
                    method:"POST",
                    data:new FormData(this),
                    contentType: false,
                    cache: false,
        ...
        $("#branch_email").blur(function () {
            ...
            if (/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test($('#branch_email').val())) {
                ...
                $.ajax({
                    url: "{{ route('business.validation_email_duplication')}}",
                    method: 'post',
                    data: {
        ...
        function edit_branch(id){
            $('#form_result').html('');
            $.ajax({
                url:"{{url('business/get_branch')}}/"+id,
                dataType:"json",
                success:function(html){
        ...
        function delete_branch(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url:"{{url('business/delete_branch')}}/"+id,
                        dataType:"json",
                        success:function(data){
                            var html = '';
                            if(data.success)
                        ...
                        if(row.priority=='1') {
                            if(row.type_mode == '0') {
                                return '<a href="javascript:visible_record_type(\''+data+'\',4)" class="text-dark" title="Visible"><i class="fa fa-unlock"></i></a> | ' +
                                    '<a href="{{url("business/recordTemplateDownload")}}/'+data+'" class="text-dark" title="Print"><i class="ion-printer"></i></a>';
                            } else {
