                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">$15<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                            ...
                            <div class="col-lg-3 m-t-30">
                                <div class="card plan-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h1 class="plan-price padding-b-15">$6<span class="text-muted m-l-10 valign-init"><sup class="font-18">each</sup></span></h1>
                                            <div class="plan-div-border"></div>
                                        </div>
                                        <div class="plan-features pb-3 mt-3 text-muted padding-t-b-30 line-height-50">
...
@section('script')
<script
    src="https://www.paypal.com/sdk/js?client-id=Af_Ms0n04D2x5xKfjM5sAqVwOKbRPSCFjq-ag1bKUh1-NqQAWFYsxPwV_FMcUsSrFzGlG3JoTuqjW2oh&currency=USD"> // Required. Replace YOUR_CLIENT_ID with your sandbox client ID.
</script>
<script>
