                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label class="col-form-label col-md-12 text-center color-black-light display-inline font-20">
                                                What is the Applicants SS Number<br> (or replacement search number):
                                            </label>
                                        </div>
                                        <div class="col-sm-12">
            ...
            <script>
                ...
                function on_sent_request_click() {
                    ...
                    if(NI_number == '') {
                        ...
                        $('#gov_number_required').html('The SS Number for the US is set so it must be at least ' + '{{$NI_min_number}}' + ' characters long.');
                        error_detect = 1;
                    } else {
