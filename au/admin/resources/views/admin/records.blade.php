            ...
            <div class="tab-content">
                <div class="tab-pane active p-3" id="search_view" role="tabpanel">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-form-label color-black-light">What is the Applicants Tax File Number?</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" required placeholder="Enter TF Number:" id="NI_search_number" />
                    ...
                    <div class="card-body custom-padding-btop ">
                        ...
                        <ul>
                            <li class="card-title mt-0 color-black-light">
                                3 records added for 1 TF Number by different users in any 6 month period.
                            </li>
                            <li class="card-title mt-0 color-black-light">
                    ...
                    <div class="card-body custom-padding-btop ">
                        ...
                        <div class="">
                            ...
                            <table class="table table-bordered table-striped m-t-10 p-2 table-hover" id="test_data_table">
                                <thead>
                                <tr>
                                    <th class="text-center">TF Number</th>
                                    <th class="text-center">Manage</th>
                                </tr>
                                </thead>
                            </table>
...
<div class="modal fade" id="test_data_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Edit Test TF Number</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="example-text-input" class="col-sm-4 col-form-label">TF Number</label>
                    <div class="col-sm-8">
