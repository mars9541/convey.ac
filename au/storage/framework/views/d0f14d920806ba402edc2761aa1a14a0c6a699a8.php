                            ...
                            <div class="col-lg-12 row" id="search_panel">
                                <div class="offset-1 col-lg-7 col-xl-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control col-sm-3  mx-auto" placeholder="Enter TF Number:" id="NI_search_number" value="ABC123456">
...
<?php echo $__env->make('layouts.master-advisors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/au/resources/views/front/advisors/search.blade.php ENDPATH**/ ?>