...
<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="">
            ...
            <a href="<?php echo e(url('citizen/home')); ?>" class="logo"><img src="<?php echo e(URL::asset('assets/images/logo.png')); ?>" height="30" alt="logo"></a>
        </div>
    </div>
    ...
    <nav class="navbar-custom">
        ...
        <li class="list-inline-item dropdown notification-list hide-sm float-right">
            <a class="nav-link waves-effect text-white" href="<?php echo e(url('citizen/contact')); ?>" id="btn-contactus">
                Contact Us
            </a>
        </li>
        ...
        <li class="list-inline-item dropdown notification-list float-right" id="message_event">
            ...
            <?php if($new_ticket_count > 0): ?>
                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                    ...
                    <!-- item-->
                    <a href="<?php echo e(route('citizen.contact')); ?>" class="dropdown-item notify-item">
...
<!-- Top Bar End -->
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/au/resources/views/layouts/topbar_citizen.blade.php ENDPATH**/ ?>