...
<script>
    ...
    $('#employee_form').on('submit', function(event) {
        ...
        if(NI_number == '') {
            $('#space_error').addClass('filled');
            $('#space_error li').html('The TF Number for the Australia is set so it must be at least ' + '<?php echo e($NI_min_number); ?>' + ' characters long.');
            error_detect = 1;
        } else {
            $('#space_error').removeClass('filled');
        }
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/au/resources/views/front/business/direct-connect.blade.php ENDPATH**/ ?>