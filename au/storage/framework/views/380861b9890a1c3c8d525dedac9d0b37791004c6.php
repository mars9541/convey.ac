                                        ...
                                        <div class="card-body color-black-light">
                                            ...
                                            <div class="text-center m-t-20" id="universal_code">
                                                <?php if(!isset($universal_code) || isset($universal_code) && $universal_code->message == ''): ?>
                                                    <form action="<?php echo e(route('advisors.generate_universal_code')); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="table-rep-plugin">
                                <div class="table-responsive mb-0" data-pattern="priority-columns">
                                    <div class="col-md-12 text-center m-t-40">
                                        ...
                                        <div class="text-center m-t-20">
                                            <p>(minimum amount to be withdrawn $200).</p>
                                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('#unique_code_table').DataTable({
            ...
            autoWidth: false,
            ajax:{
                url: "<?php echo e(route('advisors.get_unique_code')); ?>",
                method:'post',
                data:{
        ...
        $('#unique_code_generate').on('click', function(){
            ...
            {
                $.ajax({
                    url:"<?php echo e(route('advisors.save_unique_code')); ?>",
                    method:"POST",
                    data: {
                        email:$('#email').val(),
        ...
        {
            $.ajax({
                url:"<?php echo e(route('advisors.get_received_amount')); ?>",
                method:"POST",
                data: {
    ...
    <script>
        ...
        $('#received_table').DataTable({
            ...
            autoWidth: false,
            ajax:{
                url: "<?php echo e(route('advisors.receive_his')); ?>",
                method:'post',
                data:{
                    _token: $('meta[name="_token"]').attr('content')
                }
    ...
    <script>
        ...
        function withdraw_request(){
            ...
            {
                if(parseInt(withdraw_amount) >= 200){
                    $('.loading-show2').css('display','contents');
                    $('#withdraw_btn').prop('disabled', true);
                    $.ajax({
                        url:"<?php echo e(route('advisors.withdraw_request')); ?>",
                        method:"POST",
                        data: {
        ...
        $('#save_bank').on('click', function(){
            ...
            $.ajax({
                url:"<?php echo e(route('advisors.add_paypal')); ?>",
                method:"POST",
        ...
        $('#withdraw_table').DataTable({
            ...
            autoWidth: false,
            ajax:{
                url: "<?php echo e(route('advisors.withdraw_his')); ?>",
                method:'post',
                data:{
                    _token: $('meta[name="_token"]').attr('content')
                }
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if(row.status == '0') {
                            ...
                            return `<a href="<?php echo e(url('advisors/advice_note_download')); ?>/`+data+`" class="text-convey-green">payment advice note</a>`;
                        }
                    }
                }
            ]
...
<?php echo $__env->make('layouts.master-advisors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/au/resources/views/front/advisors/invite-codes.blade.php ENDPATH**/ ?>