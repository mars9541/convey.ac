                            ...
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                ...
                                <form method="post" id="sample_form" class="form-horizontal"
                                                ...
                                                <select class="form-control" name="company_lrd_country_show" required
                                                    ...
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                                <?php if( $key == "AU" ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <?php elseif($user_info->business_type=='company'): ?>
                                        ...
                                        <div class="col-md-12 m-t-15 display-inline">
                                            <label class="col-form-label col-md-4 text-right color-black-light">Mailing Address
                                                - Street/Road:</label>
                                            <div class="col-md-7 display-inline">
                                                <input type="text" class="form-control" name="ma_street"
                                                       value="<?php echo e($user_info->ma_street); ?>" required/>
                                    ...
                                    <?php elseif($user_info->business_type=='selfemployed'): ?>
                                        ...
                                        <div class="col-md-12 m-t-15 display-inline">
                                            ...
                                            <div class="col-md-7 display-inline">
                                                <input type="hidden" value="AU" name="lrd_country">
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/au/resources/views/front/business/settings.blade.php ENDPATH**/ ?>