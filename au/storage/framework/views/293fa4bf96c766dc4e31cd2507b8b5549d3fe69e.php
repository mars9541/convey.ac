                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <?php if($user_info->business_type=='organisation'): ?>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="AU" name="company_lrd_country">

                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php if( $key == "AU" ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 m-t-30  display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            ...
                                            <small style="display: none;" id="company_no_error" class="text-danger">
                                                Must be a 9 digit Australia company number at least.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                ...
                                <?php elseif($user_info->business_type=='selfemployed'): ?>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="AU" name="lrd_country_show">
...
<script>
    ...
    $('#detail_form').on('submit', function(event) {
        ...
        if(business_type == 'company') {
            ...
            if (!/^([A-Za-z0-9]{8,9})$/.test(company_no)) {
                $('input[name=company_no]').css('box-shadow', '0px 0px 4px red');
                $('input[name=company_no]').css('margin-bottom', '0px');
                $('#company_no_error').show();
...
<?php echo $__env->make('layouts.master-hris', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/au/resources/views/front/hris/settings.blade.php ENDPATH**/ ?>