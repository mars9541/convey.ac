                                      ...
                                      <input type="hidden" value="AU" name="lrd_country">
                                        <select class="form-control" name="lrd_country_show" required disabled>
                                            ...
                                            <option
                                                ...
                                                <?php if( $key == "AU" ): ?> selected <?php endif; ?>>
                                                <?php echo e($country); ?>
                                ...
                                <div class="col-md-12 m-t-15 display-inline">
                                    ...
                                    <div class="col-md-7 display-inline">
                                        <select class="form-control" name="lrd_nationality" required>
                                            ...
                                            <option
                                                value="<?php echo e($key); ?>"
                                                <?php if( $user_info->lrd_nationality == $key ): ?> selected <?php endif; ?>>
                                                <?php echo e($country); ?>
...
<?php echo $__env->make('layouts.master-advisors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/au/resources/views/front/advisors/settings.blade.php ENDPATH**/ ?>