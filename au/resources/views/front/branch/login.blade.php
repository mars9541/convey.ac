...
<html lang="en">
  <head>
    ...
    <link href="{{asset('assets')}}/scss/_form-advanced.scss" rel="stylesheet" type="text/css" />
...
<section class="login">
        <div class="container login-container">
            <div class="loginPage loginForm">
                ...
                <form action="{{route('branch_login')}}" method="post">
                    @csrf
                <div class="loginDetail" >
                    <div class="loginDetail-inner" style="max-width: 440px;margin: 0 auto;">
                        ...
                        <input type="text" class="form-control" name="ID_code" placeholder="Branch ID" required value="{{old('ID_code')}}" autocomplete="off">
