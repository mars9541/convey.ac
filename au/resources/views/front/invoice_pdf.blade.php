...
{{--                        <img src="{{url('public/upload')}}/{{$record_logo}}" class="float-right" height="50"/>--}}
	    ...
	    <div class="col-md-12 m-t-10 invoice-title">
	        <div class="row" style="padding-bottom: 0px;">
	            <div style="padding:0px 5px;">
	                <p class="title-info inline" >Invoice No.  {{$spec_info->country_ID}}/{{$data->invoice_number}}</p>
	    ...
	    <table id="payment_receipt_invoice_to" class="m-t-10">
	        ...
	        <tbody>
	            <tr>
	                <td class="test-font-12">{{$data->cbr->ocb_name}}</td>
	            </tr>
	            <tr>
	    ...
	    <table id="payment_receipt_info" class="table m-t-20">
	        ...
	        <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center border-invoice-tax" >{{number_format($data->payment_amount_excluding_vat,2)}}</td>
                </tr>
                <tr>
                    <td colspan="2" class="border-none"></td>
                    <td colspan="2" class="text-center border-invoice-tax" >Sales Tax </td>
                    <td class="text-center border-invoice-tax" >{{number_format($data->vat_amount,2)}}</td>
                </tr>
                <tr>
                    <td colspan="2" class="border-none"></td>
