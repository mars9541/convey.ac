...
<div class="card-body" style="background-color:white;">
    <div class="col-md-12 row">
        ...
        <div class="col-md-6 display-inline">
            <div>
                @if($record_logo)
{{--                    <img src="{{url('public/upload')}}/{{$record_logo}}" class="float-right" height="50"/>--}}
                    <img src="{{url('public')}}/logo.png" class="float-right" height="50"/>
                @else
                    <img src="{{url('public')}}/logo.png" class="float-right" height="50"/>
                @endif
            </div>
    ...
    <div class="col-md-12 m-t-10 invoice-title">
        <div class="row" style="padding-bottom: 0px;">
            <div style="padding:0px 5px;">
                <p class="title-info inline" >Advice Note Number.  {{$spec_info->country_ID}}/{{$data->payment_advice_note_number}}</p>
                <p class=" text-right inline" >
                    Date: {{date_format(date_create($data->created_at),'d/m/y')}}
                </p>
    ...
    <table id="payment_receipt_invoice_to" class="m-t-10">
        <thead>
            <tr>
                <td width="70%">Payment Made to:</td>
                <td style="text-align: right;">Payment Reference Number:</td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>{{$data->cbr->ocb_name}}</td>
                <td style="text-align: right">{{$data->withdraw_reference_from_processor}}</td>
            </tr>
            <tr>
            	<td>{{$data->cbr->ma_HBN}}  {{$data->cbr->ma_street}}</td>
            	<td></td>

            </tr>
            <tr>
                <td>{{$data->cbr->ma_town_or_city}} </td>
                <td></td>
            </tr>
            <tr>
                <td>{{$data->cbr->ma_postcode}} </td>
                <td></td>
            </tr>
    ...
    <table id="payment_receipt_info" class="table m-t-20">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    {{number_format($data->withdraw_amount_excluding_vat,2)}}
                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    {{number_format($spec_info->VAT_percentage,2)}}
                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    {{number_format($data->vat_amount,2)}}
                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    {{number_format($data->withdraw_amount_including_vat,2)}}
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2" class="text-center">Subtotal (ex TAX)</td>
                <td class="text-center border-invoice-sum">{{number_format($data->withdraw_amount_excluding_vat,2)}}</td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center">Sales Tax </td>
                <td class="text-center border-invoice-sum">{{number_format($data->vat_amount,2)}}</td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
            ...
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center" style="padding: 5px 12px!important; border-bottom: 2px solid #dee2e6; border-top: 2px solid #dee2e6;">
                    Total Due
                </td>
                <td class="text-center" style="padding: 5px 12px!important; border-bottom: 2px solid #dee2e6; border-top: 2px solid #dee2e6;">
                    {{number_format($data->withdraw_amount_including_vat,2)}}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="3" class="border-none">All prices are in  :{{$spec_info->currency}}</td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center border-none"></td>
