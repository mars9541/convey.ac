          ...
          <div id="form_overlay">
            ...
            <div class="loginDetail">
                ...
                <div class="loginDetail-inner " id="step_1">
                    <h2>{{__('REGÍSTRATE AHORA')}} <span>(PASO 1 DE 4)</span></h2>
                    ...
                    <select class="form-control" required name="user_type" id="user_type">
                        ...
                        <option value="advisors"> Una para Reclutadores/Desarrolladores/Asesores/Escritores</option>
                    ...
                    <div class="col-md-12 test-font-16 hidden" id="advisors_radio">
                        ...
                        <div>
                            ...
                            <label for="bb"> Proporcionamos servicios de RRHH</label>
                        </div>
                        <div>
                            <input type="radio" name="advisors_type"  id="cc" value="writer">
                            <label for="cc"> Ofrecemos servicios de contratación</label>
                        </div>
                    </div>
                </div>
