                ...
                <div class="loginDetail">
                    <div class="loginDetail-inner" style="max-width: 440px;">
                        ...
                        <div class="col-sm-12 alert alert-convey-success alert-dismissible fade show text-white" style="background-color: #3BC850;" role="alert">
                            ...
                            <strong>Advertencia!</strong> {{ $errors->first('email') }}
                        </div>
                        @endif
                        ...
                        <input type="email" class="form-control" name="email" placeholder="Introduce tu dirección de correo electrónico" required value="{{old('email')}}">
                        ...
                        <a href="#" onclick="document.getElementById('captcha').src = '{{url('vendor')}}/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">Cambiar imagen</a>
                    </div>
                </div>
                <div class="loginBottom" style="width: 440px;">
					<button  class="btn btn-primary submitBtn">INICIA SESIÓN</button>
					<a href="{{route('login_retrieval')}}" class="clickhere text-convey-green" >Haz clic aquí para recuperar tus datos</a>
                </div>
                </form>
            </div>
        </div>
