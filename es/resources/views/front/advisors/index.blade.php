                        ...
                        <div class="form-group row m-b-0" style="padding-left: 8px; padding-right: 8px;     margin-inline: 15px;">
                            <div class="col-md-12 text-center">
                                <div class="alert  {{$confirm->email=='yes'?'alert-convey-success bg-convey-green':'alert-convey-danger bg-rich-red'}} text-white" role="alert">
                                    <img src="{{$confirm->email=='yes'?asset('assets/images/checkmark.png'):asset('assets/images/question-mark.png')}}" style="width: 25px;">
                            ...
                            <div class="col-sm-12 text-center">
                                <div class="alert  {{$confirm->referrer=='yes'?'alert-convey-success bg-convey-green':'alert-convey-danger bg-rich-red'}} text-white" role="alert">
                                    <img src="{{$confirm->referrer=='yes'?asset('assets/images/checkmark.png'):asset('assets/images/question-mark.png')}}" style="width: 25px;">
