    ...
    <div class="col-md-12 m-t-10 invoice-title">
        <div class="row" style="padding-bottom: 0px;">
            <div style="padding:0px 5px;">
                <p class="title-info inline" >Receipt Number: {{$spec_info->country_ID}}/{{$data->receipt_number}}</p>
                <p class=" text-right inline" >
                    Date: {{date_format(date_create($data->created_at),'d/m/y')}}
                </p>
                <p class="title-info" >For Invoice:  {{$spec_info->country_ID}}/{{$data->invoice_number}}</p>
    ...
    <table id="payment_receipt_info" class="table m-t-20">
        ...
        <tbody>
            <tr style="border-bottom: 2px solid #dee2e6;">
                ...
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    {{number_format($data->payment_amount_excluding_vat,2)}}
                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                ...
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    {{number_format($data->payment_amount_including_vat,2)}}
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="text-center border-invoice-sum">{{number_format($data->payment_amount_excluding_vat,2)}}</td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
