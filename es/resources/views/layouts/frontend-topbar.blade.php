                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light btco-hover-menu">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto business-nav left-nav hidden-lg hidden-md hidden-sm hidden-xs" style="margin-right: 50px!important;">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/')}}">Visión general</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/benefits')}}">Beneficios</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/price')}}">Precio</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/secure')}}">Seguridad</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/upgrade')}}">Actualizar</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/more')}}">MÁS</a>
                                </li>
                            </ul>
                            ...
                            <ul class="navbar-nav ml-auto right-nav business-nav">
                                ...
                                <li class="nav-item hidden-md hidden-sm hidden-xs">
                                    <a class="nav-link d-inline-flex align-items-center" href="javascript:void(0)" >
                                        ...
                                        <img id="img_country" src="{{asset('landing_front')}}/images/country/spain.png" style="width: 20px; height: 20px;" alt="Spain">
                                ...
                                <li class="nav-item lgin-sgn-item">
                                    <a class="nav-link" id="a_login" href="{{route('login')}}">Entrar en</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="a_signup" href="{{route('register')}}" style="font-size: 15px!important;"><span class="highlight px-3">ACTUALIZAR AHORA</span></a>
                                </li>
