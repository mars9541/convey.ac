        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            <li><a href="{{url('/press')}}">Prensa</a></li>
                            <li><a href="{{url('/brand')}}">Guía de marca</a></li>
                            <li><a href="{{url('/getintouch')}}"> Contacto</a></li>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="{{asset('landing_front')}}/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="REINO UNIDO">
                                    <span>REINO UNIDO</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="{{asset('landing_front')}}/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="EE.UU.">
                                    <span>EE.UU.</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ca')">
                                    <img src="{{asset('landing_front')}}/images/country/canada.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Canadá">
                                    <span>Canadá</span>
                                </a>
                            </li>
                            <li class="float-none">
                            ...
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="{{asset('landing_front')}}/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="España">
                                    <span>España</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="{{asset('landing_front')}}/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Alemania">
                                    <span>Alemania</span>
                                </a>
                            </li>
                            <li class="float-none">
                            ...
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="{{asset('landing_front')}}/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Italy">
                                    <span>Italy</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="{{asset('landing_front')}}/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Japan">
                                    <span>Japan</span>
                                </a>
                            </li>
