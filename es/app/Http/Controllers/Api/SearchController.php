...
class SearchController extends Controller
{
    ...
    {
        if($request->National_Number != 'ABC1234567') {
        ...
        $messages = array(
            'National_Number.min' => 'The Numero de Identificacion Fiscal for the Spain is set so it must be at least '.$min_num.' characters long.',
        );
                ...
                if(count($max_version) > 0) {
                    foreach ($max_version as $key => $child) {
                        ...
                        if($request->National_Number != 'ABC1234567') {
                            ...
                            $child_record_pattern_array->Record_creators_CBR_id = "ES000000";
...
//                    array_push($item_child, $child_record_pattern_array);
                ...
                if($request->National_Number != 'ABC1234567') {
                    ...
                    $record_pattern_array->Record_creators_CBR_id = "ES000000";
...
//                date_modify($today, "-10 minutes");
    ...
    public function request_record_unlock(Request $request)
    {
        ...
        if($request->National_Number == 'ABC1234567') {
            return response()->json(['errors' => ['This test number is internally controlled and cannot be added to ABC1234567']]);
        }
