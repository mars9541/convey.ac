...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $country = Country_list::where('short_lang', 'es')->get();
...
//dd($securimage->check($request->captcha_code),$request->captcha_code);
        if ($securimage->check($request->captcha_code) == false) {
            return redirect()->back()->withInput()->with('captch_error', 'El código Captcha es incorrecto. Por favor, inténtelo de nuevo!');
        }
