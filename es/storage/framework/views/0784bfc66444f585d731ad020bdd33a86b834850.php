                    ...
                    <div class="tab-pane p-3" id="record_settings" role="tabpanel">
                        <div class="table-rep-plugin">
                            ...
                            <form  id="record_settings_from">
                                <div class="table-responsive mb-0" data-pattern="priority-columns">
                                    <div class="col-md-12 m-t-40 display-inline">
                                        <label class="col-form-label col-md-3 text-right color-black-light" for="ni">NIF: </label>
                                        <div class="col-md-8 display-inline">
...
<?php echo $__env->make('layouts.master-citizen', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/es/resources/views/front/citizen/settings.blade.php ENDPATH**/ ?>