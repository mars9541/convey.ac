                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <?php if($user_info->business_type=='organisation'): ?>
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="ES" name="company_lrd_country">
                                            ...
                                            <select class="form-control" name="company_lrd_country_show" required disabled>
                                                ...
                                                <option value="<?php echo e($key); ?>" <?php if( $key == "ES" ): ?> selected <?php endif; ?>><?php echo e($country); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Dirección postal - House/Building Number:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Dirección postal - Street/Road:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_street" value="<?php echo e($user_info->ma_street); ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Dirección postal - Town/City:</label>
                                        <div class="col-md-7 display-inline">
                                            <input type="text" class="form-control" name="ma_town_or_city" value="<?php echo e($user_info->ma_town_or_city); ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                        <label class="col-form-label col-md-4 text-right color-black-light">Dirección postal - Postcode:</label>
                                        <div class="col-md-7 display-inline">
                                    ...
                                    <div class="col-md-12 m-t-30  display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                            ...
                                            <small style="display: none;" id="company_no_error" class="text-danger">
                                                Must be 9 digits Spain CIF at least.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-12 m-t-15 display-inline">
                                ...
                                <?php elseif($user_info->business_type=='selfemployed'): ?>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="ES" name="lrd_country_show">
...
<?php echo $__env->make('layouts.master-hris', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/es/resources/views/front/hris/settings.blade.php ENDPATH**/ ?>