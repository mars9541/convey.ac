                    ...
                    <div class="col-md-8">
                        <div class="about-business-left-2x">
                            ...
                            <p>Lo ideal es que nuestro logotipo se muestre siempre a todo color, pero entendemos que a veces puedes necesitar utilizarlo en un solo color. Los ejemplos que se muestran aquí muestran cómo debería mostrarse nuestro logotipo en diferentes condiciones. Descarga nuestros logotipos aquí:
                                <br><br>&nbsp&nbsp&nbsp&nbsp<a href="<?php echo e(url('frontend_downloadable_file/convey_colour_logo')); ?>" class="color-black-light downloadable-tag">Logotipo en color</a>&nbsp&nbsp|&nbsp&nbsp <a href="<?php echo e(url('frontend_downloadable_file/convey_black_logo')); ?>" class="color-black-light downloadable-tag">Logotipo negro sobre blanco</a>&nbsp&nbsp|&nbsp&nbsp <a href="<?php echo e(url('frontend_downloadable_file/convey_white_logo')); ?>" class="color-black-light downloadable-tag">Logotipo blanco sobre negro</a></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/es/resources/views/front/brand.blade.php ENDPATH**/ ?>