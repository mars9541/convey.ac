...
.bg-emerald {
  ...
  border: 1px solid #3BC850;
}

.bg-emerald:hover {
  background-color: #066510;
  border: 1px solid #066510;
}
...
.side-menu {
  ...
  position: absolute;
  z-index: 99;
  -webkit-box-shadow: 3px 8px 5px rgba(29, 30, 58, 0.03);
...
===================*/
@media  print {
  .logo, .page-title-box, .breadcrumb, .footer, .topbar, .side-menu {
    display: none;
    margin: 0;
    padding: 0;
  }
...
.btn-primary:not([disabled]):not(.disabled).active:focus, .btn-primary:not([disabled]):not(.disabled):active:focus, .show > .btn-primary.dropdown-toggle:focus {
  -webkit-box-shadow: 0 0 0 2px rgba(99, 98, 187, 0.5);
          box-shadow: 0 0 0 2px rgba(99, 98, 187, 0.5);
}
...
.btn-secondary.focus, .btn-secondary:focus, .btn-outline-secondary.focus, .btn-outline-secondary:focus {
  -webkit-box-shadow: 0 0 0 2px rgba(156, 161, 165, 0.5);
          box-shadow: 0 0 0 2px rgba(156, 161, 165, 0.5);
}
...
.btn-success:not([disabled]):not(.disabled).active:focus, .btn-success:not([disabled]):not(.disabled):active:focus, .show > .btn-success.dropdown-toggle:focus {
  -webkit-box-shadow: 0 0 0 2px rgba(40, 211, 171, 0.5);
          box-shadow: 0 0 0 2px rgba(40, 211, 171, 0.5);
}
...
.btn-info:not([disabled]):not(.disabled).active:focus, .btn-info:not([disabled]):not(.disabled):active:focus, .show > .btn-info.dropdown-toggle:focus {
  -webkit-box-shadow: 0 0 0 2px rgba(0, 189, 255, 0.5);
...
.btn-warning:not([disabled]):not(.disabled).active:focus, .btn-warning:not([disabled]):not(.disabled):active:focus, .show > .btn-warning.dropdown-toggle:focus {
  -webkit-box-shadow: 0 0 0 2px rgba(255, 187, 68, 0.5);
          box-shadow: 0 0 0 2px rgba(255, 187, 68, 0.5);
}
...
.btn-danger:not([disabled]):not(.disabled).active:focus, .btn-danger:not([disabled]):not(.disabled):active:focus, .show > .btn-danger.dropdown-toggle:focus {
  -webkit-box-shadow: 0 0 0 2px rgba(232, 72, 72, 0.5);
          box-shadow: 0 0 0 2px rgba(232, 72, 72, 0.5);
}
...
.btn-dark:not([disabled]):not(.disabled).active, .btn-dark:not([disabled]):not(.disabled):active, .show > .btn-dark.dropdown-toggle {
  -webkit-box-shadow: 0 0 0 2px rgba(60, 73, 89, 0.5);
          box-shadow: 0 0 0 2px rgba(60, 73, 89, 0.5);
}
...
.swal2-icon.swal2-success .swal2-success-ring {
  border-color: #28D3AB !important;
}

.swal2-icon.swal2-success [class^=swal2-success-line] {
  background: #28D3AB !important;
}
...
.message-list li.active:hover {
  -webkit-box-shadow: inset 3px 0 0 #6362bb;
          box-shadow: inset 3px 0 0 #6362bb;
}
...
.irs--modern .irs-bar, .irs--modern .irs-to, .irs--modern .irs-from, .irs--modern .irs-single {
  background: #6362bb !important;
}

.irs--modern .irs-to:before, .irs--modern .irs-from:before, .irs--modern .irs-single:before {
  border-top-color: #6362bb;
}
...
.custom-control-input:focus ~ .custom-control-indicator {
  -webkit-box-shadow: 0 0 0 1px #ffffff, 0 0 0 3px #6362bb;
  box-shadow: 0 0 0 1px #ffffff, 0 0 0 3px #6362bb;
}
...
.bootstrap-touchspin .input-group-addon {
  ...
  text-align: center;
  background-color: #eeeeee;
  border: 1px solid rgba(60, 73, 89, 0.15);
}
...
.wizard > .steps .number {
  ...
  text-align: center;
  margin-right: 10px;
  background-color: rgba(99, 98, 187, 0.25);
}
...
.gmaps-overlay_arrow.below {
  ...
  border-left: 16px solid transparent;
  border-right: 16px solid transparent;
  border-bottom: 16px solid #6362bb;
}
...
table#payment_receipt_invoice_to {
    width: 100%;
}

table#payment_receipt_invoice_to tbody tr td {
    width: 100%;
    padding: 3px 12px 0 12px;
}

#payment_receipt_invoice_to thead tr td {
    vertical-align: bottom;
...
#payment_receipt_info thead tr td {
...
#payment_receipt_info tbody tr td {
...
<div class="card-body" style="background-color:white;">
    <div class="col-md-12 row">
        <div class="col-md-6 display-inline">
            <p class="header-label">CONVEY Databank Ltd</p>
            <p class="header-label">85 Great Portland Street, <br>First Floor, London, <br>W1W7LT</p>
            <p class="header-label"><br>VAT: 393 5125 86</p>
        </div>
        <div class="col-md-6 display-inline">
            <div>
                <?php if($record_logo): ?>

                    <img src="<?php echo e(url('public')); ?>/logo.png" class="float-right" height="50"/>
                <?php else: ?>
                    <img src="<?php echo e(url('public')); ?>/logo.png" class="float-right" height="50"/>
                <?php endif; ?>
            </div>
    ...
    <div class="col-md-12 text-center m-t-20 header-title">
        Payment Receipt
    </div>
    <div class="col-md-12 m-t-10 invoice-title">
        <div class="row" style="padding-bottom: 0px;">
            <div style="padding:0px 5px;">
                <p class="title-info inline" >Receipt Number: <?php echo e($spec_info->country_ID); ?>/<?php echo e($data->receipt_number); ?></p>
                <p class=" text-right inline" >
                    Date: <?php echo e(date_format(date_create($data->created_at),'d/m/y')); ?>

                </p>
                <p class="title-info" >For Invoice:  <?php echo e($spec_info->country_ID); ?>/<?php echo e($data->invoice_number); ?></p>
    ...
    <table id="payment_receipt_invoice_to" class="m-t-10">
        <thead>
            <tr>
                <td>Invoice to:</td>
            </tr>
        ...
        <tbody>
            <tr>
                <td><?php echo e($data->cbr->ocb_name); ?></td>
            </tr>
            <tr>
            	<td><?php echo e($data->cbr->ma_HBN); ?>  <?php echo e($data->cbr->ma_street); ?></td>

            </tr>
            <tr>
                <td><?php echo e($data->cbr->ma_town_or_city); ?> </td>
            </tr>
            <tr>
                <td><?php echo e($data->cbr->ma_postcode); ?> </td>
            </tr>
    ...
    <table id="payment_receipt_info" class="table m-t-20">
        <thead>
            <tr class="bg-pure-black">
                <td class="text-center">Description</td>
                <td class="text-center">Unit Price</td>
                <td class="text-center">Tax Rate</td>
                <td class="text-center">VAT Total</td>
                <td class="text-center">Total</td>
            </tr>
        </thead>
        <tbody>
            <tr style="border-bottom: 2px solid #dee2e6;">
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    Search Credits
                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    <?php echo e(number_format($data->payment_amount_excluding_vat,2)); ?>

                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    <?php echo e(number_format($spec_info->VAT_percentage,2)); ?>

                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    <?php echo e(number_format($data->vat_amount,2)); ?>

                </td>
                <td class="text-center" style="padding: 10px 12px!important; border-bottom: 2px solid #dee2e6;">
                    <?php echo e(number_format($data->payment_amount_including_vat,2)); ?>
            ...
            <tr>
                ...
                <td colspan="2" class="text-center border-invoice-sum">Subtotal (ex TAX)</td>
                <td class="text-center border-invoice-sum"><?php echo e(number_format($data->payment_amount_excluding_vat,2)); ?></td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center border-invoice-sum">Sales Tax </td>
                <td class="text-center border-invoice-sum"><?php echo e(number_format($data->vat_amount,2)); ?></td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center border-invoice-sum">&nbsp; </td>
                <td class="text-center border-invoice-sum"></td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center" style="border-bottom: 2px solid #dee2e6; border-top: 2px solid #dee2e6;">
                    Total received
                </td>
                <td class="text-center" style="border-bottom: 2px solid #dee2e6; border-top: 2px solid #dee2e6;">
                    <?php echo e(number_format($data->payment_amount_including_vat,2)); ?>
            ...
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center border-none"></td>
                <td class="border-none"></td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="3" class="border-none">All prices are in :<?php echo e($spec_info->currency); ?></td>
            </tr>
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="2" class="text-center border-none"></td>
            ...
            <tr>
                <td colspan="2" class="border-none"></td>
                <td colspan="3" class="border-none">Thank you for your business!</td>
            </tr>
...
<?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/es/resources/views/front/receipt_pdf.blade.php ENDPATH**/ ?>