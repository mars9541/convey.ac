        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="business-footer-address-left">
                        <ul>
                            <li><a href="<?php echo e(url('/press')); ?>">Prensa</a></li>
                            <li><a href="<?php echo e(url('/brand')); ?>">Guía de marca</a></li>
                            <li><a href="<?php echo e(url('/getintouch')); ?>"> Contacto</a></li>
                            <li><a href="javascript:onOpenModal('cookies')"> Cookies</a></li>
                            <li><a href="javascript:onOpenModal('privacy')"> Privacidad</a></li>
                            <li><a href="javascript:onOpenModal('legal')"> Aviso legal</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul style="margin: 40px 0 5px 0;">
                            <li class="float-none">
                                <a onclick="onCountrySite('gb')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/england.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="REINO UNIDO">
                                    <span>REINO UNIDO</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('us')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/usa.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="EE.UU.">
                                    <span>EE.UU.</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('ca')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/canada.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Canadá">
                                    <span>Canadá</span>
                                </a>
                            </li>
                            <li class="float-none">
                            ...
                            <li class="float-none">
                                <a onclick="onCountrySite('es')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/spain.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="España">
                                    <span>España</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('de')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/germany.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Alemania">
                                    <span>Alemania</span>
                                </a>
                            </li>
                            <li class="float-none">
                            ...
                            <li class="float-none">
                                <a onclick="onCountrySite('it')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/italy.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Italy">
                                    <span>Italy</span>
                                </a>
                            </li>
                            <li class="float-none">
                                <a onclick="onCountrySite('jp')">
                                    <img src="<?php echo e(asset('landing_front')); ?>/images/country/japan.png" style="width: 20px; height: 20px; margin-bottom: 5px;" alt="Japan">
                                    <span>Japan</span>
                                </a>
                            </li>
...
<div class="modal fade bs-example-modal-lg" id="privacy_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">Política de privacidad</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 1.75rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 1rem!important;">Nombre de la empresa: CONVEY Databank Ltd <br>
                        Dirección de la empresa:  85 Great Portland Street, First Floor, Londres, W1W7LT
                    </p>
                    <p style="margin-bottom: 1rem!important;">
                        En CONVEY nos preocupa su privacidad.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Por eso sólo recogemos sus datos personales si tenemos una buena razón para hacerlo y por eso también queremos comunicar de forma transparente lo que hacemos con sus datos personales, la política de privacidad difiere ligeramente según el uso que haga de CONVEY, por ejemplo, un individuo que utilice CONVEY para encontrar registros sobre sí mismo tendrá una política ligeramente diferente a la de una empresa que utilice CONVEY para crear registros.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Durante el proceso de creación de la cuenta se pueden consultar las condiciones de uso completas y pertinentes.
                    </p>
...
<div class="modal fade bs-example-modal-lg" id="legal_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="article_title">Aviso legal</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <div class="modal-body" style="padding: 2rem!important;">
                <div class="form-group" id="article_detail">
                    <p style="margin-bottom: 0.7rem!important;">Nombre de la empresa: CONVEY Databank Ltd </p>
                    <p style="margin-bottom: 0.7rem!important;">Dirección de la empresa:  85 Great Portland Street, First Floor, Londres, W1W7LT </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        El sitio web CONVEY.ac , accesible a través de la siguiente URL: https://www.convey.ac, es propiedad de CONVEY Databank Ltd, una sociedad limitada privada registrada en el Reino Unido, con domicilio social en 85 Great Portland Street, First Floor, Londres, W1W7LT
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        El sitio web ha sido desarrollado y es mantenido por CONVEY Databank Ltd, con alojamiento geográfico en el Reino Unido, la UE y los Estados Unidos.
                    </p>
                    <p style="margin-bottom: 0.5rem!important; line-height: 25px!important;">
                        Las condiciones de uso completas se pueden consultar durante el proceso de creación de la cuenta.
                    </p>
                    <p style="line-height: 25px!important;">
                        Para soporte/reclamaciones: Por favor, utilice el formulario de contacto del sitio.
                    </p>
                </div>
...
<?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/es/resources/views/layouts/frontend-footer.blade.php ENDPATH**/ ?>