    ...
    <div class="col-md-12 bg-white">
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <?php if($user_info->advisors_type != 'writer'): ?>
                    <li class="nav-item">
                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <form id="update_account">
                                ...
                                <div class="col-md-12 m-t-30 display-inline text-center">
                                    ...
                                    <label class="col-form-label col-md-2 text-left color-black-light" for="c">Writer</label>
                                </div>
...
<?php echo $__env->make('layouts.master-advisors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/es/resources/views/front/advisors/settings.blade.php ENDPATH**/ ?>