                ...
                <div class="loginDetail">
                    <div class="loginDetail-inner" style="max-width: 440px;">
                        ...
                        <div class="col-sm-12 alert alert-convey-success alert-dismissible fade show text-white" style="background-color: #3BC850;" role="alert">
                            ...
                            <strong>Advertencia!</strong> <?php echo e($errors->first('email')); ?>
                        ...
                        <input type="email" class="form-control" name="email" placeholder="Introduce tu dirección de correo electrónico" required value="<?php echo e(old('email')); ?>">
                        ...
                        <input type="text" name="captcha_code" size="28" maxlength="6" required placeholder="Resuelve e introduce la suma anterior" style="padding-inline:5px;" autocomplete="off"/>
                        <a href="#" onclick="document.getElementById('captcha').src = '<?php echo e(url('vendor')); ?>/securimage/securimage_show.php?' + Math.random(); return false" class="text-convey-green">Cambiar imagen</a>
                    </div>
                </div>
                <div class="loginBottom" style="width: 440px;">
					<button  class="btn btn-primary submitBtn">INICIA SESIÓN</button>
					<a href="<?php echo e(route('login_retrieval')); ?>" class="clickhere text-convey-green" >Haz clic aquí para recuperar tus datos</a>
                </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/es/resources/views/auth/login.blade.php ENDPATH**/ ?>