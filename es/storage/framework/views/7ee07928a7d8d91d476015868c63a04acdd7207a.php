...
<script>
    $('#hris_software_table').DataTable({
        ...
        ajax:{
            url: "<?php echo e(route('hris.get_hris')); ?>",
            method:'post',
            data: function ( d ) {
                d.filter = 'software';
            },
...
<?php echo $__env->make('layouts.master-hris', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/es/resources/views/front/hris/promotional-tips.blade.php ENDPATH**/ ?>