                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="{{asset('landing_front')}}/images/ca/CONTROLPANEL.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="{{asset('landing_front')}}/images/ca/supplier.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
