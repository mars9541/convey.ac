                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/ca/CONTROLPANEL.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/ca/supplier.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="about-business-content-2x">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="about-business-right-2x">
                            <img class="img-responsive" src="<?php echo e(asset('landing_front')); ?>/images/api2.png" alt="sample image">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/ca/resources/views/front/upgrade.blade.php ENDPATH**/ ?>