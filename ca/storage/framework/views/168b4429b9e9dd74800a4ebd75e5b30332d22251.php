...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Create Records using HRIS Connect</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="card m-b-20 text-center">
            <div class="card-body" style="padding: 13px;">
                <p class="m-0 color-black-light">If you have an account with a HRIS provider and they are listed below you will be able to continue using their system as you do now and they will send the records you create through them to the Databank.</p>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
...
<script>
    $('#hris_software_table').DataTable({
        ...
        ajax:{
            url: "<?php echo e(route('business.get_hris')); ?>",
            method:'post',
            data: function ( d ) {
                d.filter = 'software';
            },
...
<?php echo $__env->make('layouts.master-business', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/15a/f/fc05c3f35d/public_html/ca/resources/views/front/business/hris-connect.blade.php ENDPATH**/ ?>