                            ...
                            <form method="post" id="detail_form" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <?php elseif($user_info->business_type=='selfemployed'): ?>
                                    ...
                                    <div class="col-md-12 m-t-15 display-inline">
                                        ...
                                        <div class="col-md-7 display-inline">
                                          <input type="hidden" value="CA" name="lrd_country_show">
...
<?php echo $__env->make('layouts.master-hris', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/virtual/vps-91c4dd/d/d2263f56e5/public_html/ca/resources/views/front/hris/settings.blade.php ENDPATH**/ ?>